...
requireText(pages, 'published metadata does not bind version, installer, unsigned state, and checksum', "pages.yml does not bind metadata to the selected release");
