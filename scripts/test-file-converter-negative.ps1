...
Assert-RedMutation $nativeWriter '      : OpenChild(parent.get(), guardian_name, ChildDisposition::Create, ChildAccess::WriteNew, &error);' '      : UniqueHandle{};' 'OpenChild\(parent\.get\(\),\s*guardian_name,\s*ChildDisposition::Create' 'guardian creation must retain the exact kernel handle'
