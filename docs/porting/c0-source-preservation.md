...
one exact boundary at a time. Its 38 mutations cover path membership, duplicates,
...
do not count. Four-space-or-more indented rows are also treated as indented code
and do not count. The parser tracks variable-length backtick and tilde fences, and
