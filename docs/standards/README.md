...
| [shared-ui-primitives-migration.md](shared-ui-primitives-migration.md) | Hand-written migration inventory for shared context-menu and dropdown primitives, including every current native select, direct search field, and legacy context-menu adapter row. |
