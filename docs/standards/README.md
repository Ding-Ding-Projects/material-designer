...
| [app-logo-customization.md](app-logo-customization.md) | Local app-logo presets and upload, signature-first bounded conversion, crop and fit controls, target previews, persistence and reset. |
