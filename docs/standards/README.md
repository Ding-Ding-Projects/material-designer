...
| [authenticator-and-unlock-ladder.md](authenticator-and-unlock-ladder.md) | Local authenticator protocol, vault-only storage, append-only history, and the host-owned unlock ladder. |
