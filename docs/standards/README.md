...
| [personal-vocabulary.md](personal-vocabulary.md) | Versioned local JSON wording upload, bounded validation, private UI application, cache reset, redacted history, and surface evidence. |
