...
| [search-surface-inventory.md](search-surface-inventory.md) | The hand-written desktop and documentation search inventory, exact field identities, state owners, and source-level negative check. |
...
| 4 | Regex builder on every search bar | **Partial, with the source workbench hardened.** The hand-written inventory has 33 rows: 23 wired at source level and 10 explicitly RED across the Library, site, and documentation tab lanes. FileViewer's ten real menus have distinct field identities; hosted and installed interaction remain unverified. | [regex-builder.md](regex-builder.md), [search-surface-inventory.md](search-surface-inventory.md) |
...
| Context-menu shortcuts and menu search | **Registry-backed shortcut semantics are implemented in the shared menu source, and FileViewer's ten menus are searchable at source level.** Product-wide menu adoption and installed interaction remain open. | [context-menu-shortcuts.md](context-menu-shortcuts.md), [search-surface-inventory.md](search-surface-inventory.md), [shared-material-primitives.md](shared-material-primitives.md) |
