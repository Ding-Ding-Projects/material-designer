...
| Full font control | **Reachable since 2026-09-02.** `AppearanceControls` (persisted family, size, weight, line-height, tracking, visible unsupported values) is mounted on the Appearance settings tab beside the theme control; its rendered behaviour is still unmeasured. |
