...
| URI, image, clipboard, camera, and manual registration | `authenticator/destination.ts`, `authenticator/host.ts`, `AuthenticatorDestination.tsx` | registration route tests | Integration pending | Not captured |
