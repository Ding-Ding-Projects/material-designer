...
The latest source repairs are commits `271b3da5a606ce28b4f274f0eb4194516691c060`
and `a3c1152c017263611536465f720b102ed9c0baa7`; their temporary-file tests
include changed-destination refusal and concurrent creation, and their audit
reader validates persisted records before display. These commits remain local
to the task branch until the parent
orchestrator incorporates them.
