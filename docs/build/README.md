...
| [dependency-bootstrap.md](dependency-bootstrap.md) | The root one-click dependency helpers, exact pinned inputs, digest verification, silent mode, user-scoped cache, and fresh-machine boundary. |
