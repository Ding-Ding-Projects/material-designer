...
| [self-contained-check-bundled-template-examples.md](self-contained-check-bundled-template-examples.md) | Diagnosed, not fixed. The packaged app's self-contained gate flags 435 CDN references, all 174 of them inside bundled template/plugin/skill *example* HTML — none in the application bundle itself. Narrowing the check's scope or making the catalogue offline are both live options; neither is this session's call to make alone. |
