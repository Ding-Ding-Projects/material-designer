...
> variable-length backtick inline-code spans.
> `scripts/verify-port.sh --json` remains green with expected 13,143, tracked 13,524,
> declared 818, and zero gaps. The import summary now reports 381 absent-upstream paths.
...
> 實測係 13,143、13,524、381 同 818。呢條 lane 只做 source preservation，冇
