...
> `scripts/verify-port.sh --json` remains green with expected 13,143, tracked 13,559,
> declared 864, and zero gaps. The import summary now reports 416 absent-upstream paths.
...
> 實測係 13,143、13,559、416 同 864。呢條 lane 只做 source preservation，冇
