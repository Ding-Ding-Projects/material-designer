  ...
  app.post('/api/projects', async (req, res) => {
    try {
      ...
      const desktopApplicationSelected =
        baseProjectMetadata &&
        typeof baseProjectMetadata === 'object' &&
        (baseProjectMetadata as { intent?: unknown }).intent === 'desktop-app';
      ...
      if (desktopApplicationSelected) {
        const targets = (baseProjectMetadata as { platformTargets?: unknown }).platformTargets;
