...
export interface Dict {
  ...
  'appLogo.rainbow'?: string;
  'appLogo.rainbowSpeed'?: string;
  ...
  'appLogo.sourceAlpha'?: string;
  'appLogo.sourceOpaque'?: string;
  ...
  'appLogo.lossDisclosure'?: string;
  'appLogo.schedule'?: string;
  'appLogo.scheduleHint'?: string;
  'appLogo.scheduleStart'?: string;
  'appLogo.scheduleEnd'?: string;
  'appLogo.schedulePreset'?: string;
  'appLogo.scheduleLabel'?: string;
  'appLogo.scheduleWeekdays'?: string;
  'appLogo.scheduleEnabled'?: string;
  'appLogo.scheduleDelete'?: string;
  'appLogo.scheduleEdit'?: string;
  'appLogo.sun'?: string; 'appLogo.mon'?: string; 'appLogo.tue'?: string; 'appLogo.wed'?: string; 'appLogo.thu'?: string; 'appLogo.fri'?: string; 'appLogo.sat'?: string;
  'appLogo.scheduleAdd'?: string;
  'appLogo.scheduleAdded'?: string;
  'appLogo.scheduleInvalid'?: string;
  'appLogo.noMatch'?: string;
  'appLogo.timezone'?: string;
  'appLogo.lossBefore'?: string;
  'appLogo.targetFavicon'?: string;
  'appLogo.targetToolbar'?: string;
  'appLogo.targetTitlebar'?: string;
  'appLogo.targetSidebar'?: string;
  'appLogo.targetInstaller'?: string;
  'appLogo.installerPreviewOnly'?: string;
  ...
  // Settings toy-lock UI. Optional so locales without a dedicated Cantonese
  // or English override inherit the complete English fallback safely.
  'settings.toyLock.title'?: string;
  'settings.toyLock.description'?: string;
  'settings.toyLock.searchTargetsLabel'?: string;
  'settings.toyLock.searchTargetsAria'?: string;
  'settings.toyLock.searchTargetsPlaceholder'?: string;
  'settings.toyLock.noTargetMatches'?: string;
  'settings.toyLock.targetLabel'?: string;
  'settings.toyLock.searchPoliciesLabel'?: string;
  'settings.toyLock.searchPoliciesAria'?: string;
  'settings.toyLock.searchPoliciesPlaceholder'?: string;
  'settings.toyLock.policyLabel'?: string;
  'settings.toyLock.noPolicyMatches'?: string;
  'settings.toyLock.policy.pin'?: string;
  'settings.toyLock.policy.password'?: string;
  'settings.toyLock.policy.pinPassword'?: string;
  'settings.toyLock.policy.passwordTotp'?: string;
  'settings.toyLock.policy.pinTotp'?: string;
  'settings.toyLock.policy.passwordPinTotp'?: string;
  'settings.toyLock.durationLabel'?: string;
  'settings.toyLock.duration.surface'?: string;
  'settings.toyLock.duration.fiveMinutes'?: string;
  'settings.toyLock.duration.untilClose'?: string;
  'settings.toyLock.pinEntryLegend'?: string;
  'settings.toyLock.pinMethodAria'?: string;
  'settings.toyLock.keypad'?: string;
  'settings.toyLock.manualPin'?: string;
  'settings.toyLock.pinAria'?: string;
  'settings.toyLock.password'?: string;
  'settings.toyLock.totpSecret'?: string;
  'settings.toyLock.totpSecretAria'?: string;
  'settings.toyLock.totpHint'?: string;
  'settings.toyLock.totpCode'?: string;
  'settings.toyLock.totpCodeAria'?: string;
  'settings.toyLock.confirmPairing'?: string;
  'settings.toyLock.replace'?: string;
  'settings.toyLock.save'?: string;
  'settings.toyLock.remove'?: string;
  'settings.toyLock.close'?: string;
  'settings.toyLock.recovery'?: string;
  'settings.toyLock.noticeUnavailable'?: string;
  'settings.toyLock.noticeInvalidPin'?: string;
  'settings.toyLock.noticeRequiredPassword'?: string;
  'settings.toyLock.noticeRequiredTotp'?: string;
  'settings.toyLock.noticePairingReady'?: string;
  'settings.toyLock.noticeSaved'?: string;
  'settings.toyLock.noticeSavedAfterPairing'?: string;
  'settings.toyLock.noticeRemoved'?: string;
  'settings.toyLock.noticeHostTimeout'?: string;
  'settings.toyLock.statusLoading'?: string;
  'settings.toyLock.statusUnavailable'?: string;
  'settings.toyLock.failureOsProtection'?: string;
  'settings.toyLock.failureStaleRevision'?: string;
  'settings.toyLock.failureEnrollmentMismatch'?: string;
  'settings.toyLock.failureEnrollmentExpired'?: string;
  'settings.toyLock.failureGeneric'?: string;
  'settings.toyLock.authTitle'?: string;
  'settings.toyLock.authSubtitle'?: string;
  'settings.toyLock.authProgress'?: string;
  'settings.toyLock.authAttempts'?: string;
  'settings.toyLock.authExhausted'?: string;
  'settings.toyLock.authPin'?: string;
  'settings.toyLock.authPassword'?: string;
  'settings.toyLock.authTotp'?: string;
  'settings.toyLock.authKeypad'?: string;
  'settings.toyLock.authManual'?: string;
  'settings.toyLock.authClear'?: string;
  'settings.toyLock.authBackspace'?: string;
  'settings.toyLock.authContinue'?: string;
  'settings.toyLock.authCancel'?: string;
  'settings.toyLock.authInvalidPin'?: string;
  'settings.toyLock.authRequired'?: string;
  'settings.toyLock.authRejected'?: string;
  'settings.toyLock.authVerificationFailed'?: string;
  'settings.toyLock.authVerifying'?: string;
  'settings.toyLock.editTabAppearance'?: string;
  'settings.toyLock.configure'?: string;
  'settings.toyLock.lockElement'?: string;
  'settings.toyLock.lockAgain'?: string;
  'settings.toyLock.dropdownOpen'?: string;
  'settings.toyLock.choiceStatus'?: string;
  'settings.toyLock.qrLabel'?: string;
  'settings.toyLock.qrReveal'?: string;
  'settings.toyLock.qrHide'?: string;
  'settings.toyLock.qrManual'?: string;
  'settings.toyLock.qrUnavailable'?: string;
  'settings.toyLock.qrParameters'?: string;
  'settings.toyLock.supportOpen'?: string;
  'settings.toyLock.supportTitle'?: string;
  'settings.toyLock.supportDisclosure'?: string;
  'settings.toyLock.supportSearch'?: string;
  'settings.toyLock.supportCategory'?: string;
  'settings.toyLock.supportCategoryLockedOut'?: string;
  'settings.toyLock.supportCategoryAuthenticator'?: string;
  'settings.toyLock.supportCategoryOther'?: string;
  'settings.toyLock.supportDescription'?: string;
  'settings.toyLock.supportCreate'?: string;
  'settings.toyLock.supportClose'?: string;
  'settings.toyLock.supportSelectAll'?: string;
  'settings.toyLock.supportInvert'?: string;
  'settings.toyLock.supportExport'?: string;
  'settings.toyLock.supportDismiss'?: string;
  'settings.toyLock.supportEmpty'?: string;
  'settings.toyLock.supportStatus'?: string;
  'settings.toyLock.supportOpenFolder'?: string;
  'settings.toyLock.supportFolderOpened'?: string;
  'settings.toyLock.supportRecoveryPath'?: string;
  'settings.toyLock.supportCopyPath'?: string;
  'settings.toyLock.supportPathCopied'?: string;
  'settings.toyLock.supportPathCopyUnavailable'?: string;
  'settings.toyLock.supportFolderFailed'?: string;
  'settings.toyLock.supportResolution'?: string;
  'settings.toyLock.supportReviewDismiss'?: string;
  'settings.toyLock.supportReviewExport'?: string;
  'settings.toyLock.supportReviewConfirm'?: string;
  'settings.toyLock.supportReviewCancel'?: string;
  'settings.toyLock.supportFirstResponse'?: string;
  'settings.toyLock.supportMigration'?: string;
  'settings.toyLock.supportCollisionExhausted'?: string;
  'settings.toyLock.tabAppearanceTitle'?: string;
  'settings.toyLock.tabAppearanceClose'?: string;
  'settings.toyLock.tabAppearanceHint'?: string;
  'settings.toyLock.tabAppearanceSearch'?: string;
  'settings.toyLock.tabAppearanceColors'?: string;
  'settings.toyLock.tabAppearanceTextColor'?: string;
  'settings.toyLock.tabAppearanceBackgroundColor'?: string;
  'settings.toyLock.tabAppearanceTypography'?: string;
  'settings.toyLock.tabAppearanceFontSize'?: string;
  'settings.toyLock.tabAppearanceFontWeight'?: string;
  'settings.toyLock.tabAppearanceShape'?: string;
  'settings.toyLock.tabAppearanceRadius'?: string;
  'settings.toyLock.tabAppearanceReset'?: string;
  ...
  // Extended workbench labels use optional keys so older locale dictionaries
  // continue to fall back through the same translator without raw UI copy.
  'regexBuilder.constructColumn'?: string;
  'regexBuilder.statusColumn'?: string;
  'regexBuilder.exampleColumn'?: string;
  'regexBuilder.reasonColumn'?: string;
  'regexBuilder.sourceColumn'?: string;
  'regexBuilder.rangeColumn'?: string;
  'regexBuilder.meaningColumn'?: string;
  'regexBuilder.reviewLabel'?: string;
  'regexBuilder.workbenchHint'?: string;
  'regexBuilder.replacementHint'?: string;
  'regexBuilder.replacementEmpty'?: string;
  'regexBuilder.replacementStatus'?: string;
  'regexBuilder.replacementUnavailable'?: string;
  'regexBuilder.replacementTimedOut'?: string;
  'regexBuilder.profileElapsed'?: string;
  'regexBuilder.profileTokens'?: string;
  'regexBuilder.profileMatches'?: string;
  'regexBuilder.profileSample'?: string;
  'regexBuilder.traceNote'?: string;
  'regexBuilder.snippetHint'?: string;
  'regexBuilder.snippetName'?: string;
  'regexBuilder.snippetSave'?: string;
  'regexBuilder.snippetCopy'?: string;
  'regexBuilder.snippetExport'?: string;
  'regexBuilder.snippetImport'?: string;
  'regexBuilder.snippetsCopied'?: string;
  'regexBuilder.snippetSaved'?: string;
  'regexBuilder.snippetsImported'?: string;
  'regexBuilder.snippetsEmpty'?: string;
  'regexBuilder.evaluationRefused'?: string;
  'regexBuilder.evaluationExhausted'?: string;
  'regexBuilder.highRiskReason'?: string;
  'regexBuilder.snippetImportFailed'?: string;
  'regexBuilder.unicodeCodePoint'?: string;
  'regexBuilder.unicodeCodePointHint'?: string;
  'regexBuilder.matchPrevious'?: string;
  'regexBuilder.matchNext'?: string;
  'regexBuilder.matchPosition'?: string;
  'regexBuilder.caseExpectedMatch'?: string;
  'regexBuilder.caseExpectedNoMatch'?: string;
  'regexBuilder.caseActualMatch'?: string;
  'regexBuilder.caseActualNoMatch'?: string;
  'regexBuilder.caseRefused'?: string;
  'regexBuilder.caseTimedOut'?: string;
  'regexBuilder.caseAdd'?: string;
  'regexBuilder.caseInput'?: string;
  'regexBuilder.caseExpected'?: string;
  'regexBuilder.caseSuite'?: string;
  'regexBuilder.caseEmpty'?: string;
  'regexBuilder.errorUnsafe'?: string;
  'regexBuilder.capabilityLiteral'?: string;
  'regexBuilder.capabilityUnicodeCodePoint'?: string;
  'regexBuilder.capabilityCharacterClass'?: string;
  'regexBuilder.capabilityClassIntersection'?: string;
  'regexBuilder.capabilityAnchors'?: string;
  'regexBuilder.capabilityCaptureGroups'?: string;
  'regexBuilder.capabilityNonCapturingGroups'?: string;
  'regexBuilder.capabilityAlternation'?: string;
  'regexBuilder.capabilityQuantifiers'?: string;
  'regexBuilder.capabilityLookaround'?: string;
  'regexBuilder.capabilityBackreferences'?: string;
  'regexBuilder.capabilityUnicodeProperties'?: string;
  'regexBuilder.capabilityInlineModifiers'?: string;
  'regexBuilder.capabilityAtomicGroups'?: string;
  'regexBuilder.capabilityPossessiveQuantifiers'?: string;
  'regexBuilder.capabilityConditionals'?: string;
  'regexBuilder.capabilitySubroutines'?: string;
  'regexBuilder.capabilityReplacementTemplates'?: string;
  'regexBuilder.reasonLiteral'?: string;
  'regexBuilder.reasonUnicodeCodePoint'?: string;
  'regexBuilder.reasonCharacterClass'?: string;
  'regexBuilder.reasonClassIntersection'?: string;
  'regexBuilder.reasonAnchors'?: string;
  'regexBuilder.reasonCaptureGroups'?: string;
  'regexBuilder.reasonNonCapturingGroups'?: string;
  'regexBuilder.reasonAlternation'?: string;
  'regexBuilder.reasonQuantifiers'?: string;
  'regexBuilder.reasonLookaround'?: string;
  'regexBuilder.reasonBackreferences'?: string;
  'regexBuilder.reasonUnicodeProperties'?: string;
  'regexBuilder.reasonInlineModifiers'?: string;
  'regexBuilder.reasonAtomicGroups'?: string;
  'regexBuilder.reasonPossessiveQuantifiers'?: string;
  'regexBuilder.reasonConditionals'?: string;
  'regexBuilder.reasonSubroutines'?: string;
  'regexBuilder.reasonReplacementTemplates'?: string;
  'regexBuilder.summaryUnsupported'?: string;
  'regexBuilder.summaryConditional'?: string;
  'regexBuilder.summarySupported'?: string;
  'regexBuilder.tokenLiteral'?: string;
  'regexBuilder.tokenLiteralExplanation'?: string;
  'regexBuilder.tokenEscape'?: string;
  'regexBuilder.tokenEscapeExplanation'?: string;
  'regexBuilder.tokenUnicodeProperty'?: string;
  'regexBuilder.tokenUnicodePropertyExplanation'?: string;
  'regexBuilder.tokenUnicodeCodePoint'?: string;
  'regexBuilder.tokenUnicodeCodePointExplanation'?: string;
  'regexBuilder.tokenBackreference'?: string;
  'regexBuilder.tokenBackreferenceExplanation'?: string;
  'regexBuilder.tokenCharacterClass'?: string;
  'regexBuilder.tokenCharacterClassExplanation'?: string;
  'regexBuilder.tokenClassSetNotation'?: string;
  'regexBuilder.tokenClassSetNotationExplanation'?: string;
  'regexBuilder.tokenCapturingGroup'?: string;
  'regexBuilder.tokenCapturingGroupExplanation'?: string;
  'regexBuilder.tokenGroupEnd'?: string;
  'regexBuilder.tokenGroupEndExplanation'?: string;
  'regexBuilder.tokenAlternation'?: string;
  'regexBuilder.tokenAlternationExplanation'?: string;
  'regexBuilder.tokenAnchor'?: string;
  'regexBuilder.tokenAnchorExplanation'?: string;
  'regexBuilder.tokenWildcard'?: string;
  'regexBuilder.tokenWildcardExplanation'?: string;
  'regexBuilder.tokenQuantifier'?: string;
  'regexBuilder.tokenQuantifierExplanation'?: string;
  'regexBuilder.tokenPossessive'?: string;
  'regexBuilder.tokenPossessiveExplanation'?: string;
  'regexBuilder.tokenNamedCapture'?: string;
  'regexBuilder.tokenLookahead'?: string;
  'regexBuilder.tokenLookbehind'?: string;
  'regexBuilder.tokenInlineModifier'?: string;
  'regexBuilder.tokenAtomicGroup'?: string;
  'regexBuilder.tokenSubroutine'?: string;
  'regexBuilder.tokenConditionalGroup'?: string;
  'regexBuilder.tokenUnsupportedGroup'?: string;
  'regexBuilder.tokenGenericExplanation'?: string;
  'regexBuilder.statusSupported'?: string;
  'regexBuilder.statusConditional'?: string;
  'regexBuilder.statusUnsupported'?: string;
  'regexBuilder.snippetFileTooLarge'?: string;
  'regexBuilder.snippetFileInvalid'?: string;
  'regexBuilder.snippetPersistFailed'?: string;
  'regexBuilder.engineVersion'?: string;
  'regexBuilder.versionUnavailable'?: string;
  'regexBuilder.versionFromUserAgent'?: string;
  'regexBuilder.tokenAnnotations'?: string;
  'regexBuilder.tokenEmpty'?: string;
  'regexBuilder.advancedConstructs'?: string;
  'regexBuilder.replacementAndProfile'?: string;
  'regexBuilder.replacementTemplate'?: string;
  'regexBuilder.outputTruncated'?: string;
  'regexBuilder.savedSnippets'?: string;
  ...
  'appearance.color.translations': string;
