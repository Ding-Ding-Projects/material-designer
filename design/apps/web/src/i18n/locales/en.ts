...
export const en: Dict = {
  ...
  'documentation.offlineDescription': 'Read every article offline from the bundled source tree.',
  'documentation.articlesTab': 'Articles',
  'documentation.historyTab': 'Recently read',
  'documentation.articleCount': '{count} bundled articles available offline',
  'documentation.source': 'Open source',
  'documentation.suggested': 'Suggested articles',
  'documentation.articleSearch': 'Search documentation articles',
