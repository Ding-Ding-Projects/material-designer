...
export const en: Dict = {
  ...
  'appLogo.lossBefore': 'Before activation, conversion may omit the source format, metadata, colour profile, and cropped pixels. The original file stays unchanged.',
