...
export const en: Dict = {
  'settings.toyLock.title': 'Toy locks',
  'settings.toyLock.description': 'Optional local interaction friction, not protection for sensitive data.',
  'settings.toyLock.searchTargetsLabel': 'Search settings tabs',
  'settings.toyLock.searchTargetsAria': 'Search settings tabs',
  'settings.toyLock.searchTargetsPlaceholder': 'Filter settings tabs…',
  'settings.toyLock.noTargetMatches': 'No settings tabs match this filter.',
  'settings.toyLock.targetLabel': 'Settings tab',
  'settings.toyLock.searchPoliciesLabel': 'Search authentication policies',
  'settings.toyLock.searchPoliciesAria': 'Search authentication policies',
  'settings.toyLock.searchPoliciesPlaceholder': 'Filter policies…',
  'settings.toyLock.policyLabel': 'Authentication policy',
  'settings.toyLock.noPolicyMatches': 'No authentication policies match this filter.',
  'settings.toyLock.policy.pin': 'PIN',
  'settings.toyLock.policy.password': 'Password',
  'settings.toyLock.policy.pinPassword': 'PIN and password',
  'settings.toyLock.policy.passwordTotp': 'Password and authenticator code',
  'settings.toyLock.policy.pinTotp': 'PIN and authenticator code',
  'settings.toyLock.policy.passwordPinTotp': 'Password, PIN and authenticator code',
  'settings.toyLock.durationLabel': 'Unlock duration',
  'settings.toyLock.duration.surface': 'This surface only',
  'settings.toyLock.duration.fiveMinutes': '5 minutes',
  'settings.toyLock.duration.untilClose': 'Until the application closes',
  'settings.toyLock.pinEntryLegend': 'Enter PIN',
  'settings.toyLock.pinMethodAria': 'PIN entry method',
  'settings.toyLock.keypad': 'Access keypad',
  'settings.toyLock.manualPin': 'Manual entry',
  'settings.toyLock.pinAria': 'PIN',
  'settings.toyLock.password': 'Password',
  'settings.toyLock.totpSecret': 'Authenticator Base32 secret',
  'settings.toyLock.totpSecretAria': 'Authenticator Base32 secret',
  'settings.toyLock.totpHint': 'Enter the authenticator secret. The pairing QR code is generated locally.',
  'settings.toyLock.totpCode': 'Current authenticator code',
  'settings.toyLock.totpCodeAria': 'Current authenticator code',
  'settings.toyLock.confirmPairing': 'Confirm authenticator pairing',
  'settings.toyLock.replace': 'Replace toy lock',
  'settings.toyLock.save': 'Save toy lock',
  'settings.toyLock.remove': 'Remove lock',
  'settings.toyLock.close': 'Close',
  'settings.toyLock.recovery': 'Open Support Tickets to review local recovery options. Opening the data folder does not delete or reset your data.',
  'settings.toyLock.noticeUnavailable': 'Toy locks are unavailable in this build.',
  'settings.toyLock.noticeInvalidPin': 'Enter a PIN containing 4 to 12 digits.',
  'settings.toyLock.noticeRequiredPassword': 'Enter a password before saving this policy.',
  'settings.toyLock.noticeRequiredTotp': 'Enter the authenticator Base32 secret before starting pairing.',
  'settings.toyLock.noticePairingReady': 'Pairing is ready. Enter the current six-digit authenticator code to confirm this lock.',
  'settings.toyLock.noticeSaved': 'Toy lock saved. This adds optional interaction friction; it does not encrypt your documents.',
  'settings.toyLock.noticeSavedAfterPairing': 'Authenticator confirmed and toy lock saved.',
  'settings.toyLock.noticeRemoved': 'Toy lock removed.',
  'settings.toyLock.noticeHostTimeout': 'The protected host did not respond before the deadline. Check the current state before trying again.',
  'settings.toyLock.statusLoading': 'Loading toy-lock state. Settings remain unavailable until it settles.',
  'settings.toyLock.statusUnavailable': 'Toy-lock state is unavailable. Settings remain locked until the protected host responds.',
  'settings.toyLock.failureOsProtection': 'This computer cannot provide the protected credential storage required for toy locks.',
  'settings.toyLock.failureStaleRevision': 'This lock changed elsewhere. Reload its latest status before trying again.',
  'settings.toyLock.failureEnrollmentMismatch': 'The authenticator code did not confirm pairing. Check the current code and try again.',
  'settings.toyLock.failureEnrollmentExpired': 'The pairing transaction expired. Start pairing again.',
  'settings.toyLock.failureGeneric': 'The lock change could not be confirmed. Check the current lock status before trying again.',
  'settings.toyLock.authTitle': 'Authentication required',
  'settings.toyLock.authSubtitle': 'Unlock {target} before performing its action.',
  'settings.toyLock.authProgress': 'Factor {current} of {total}: {factor}',
  'settings.toyLock.authAttempts': '{remaining} of {maximum} attempts remaining',
  'settings.toyLock.authExhausted': 'Attempt limit reached. Wait for the displayed cooldown or open Support Tickets.',
  'settings.toyLock.authPin': 'PIN',
  'settings.toyLock.authPassword': 'Password',
  'settings.toyLock.authTotp': 'Authenticator code',
  'settings.toyLock.authKeypad': 'Access keypad',
  'settings.toyLock.authManual': 'Manual PIN entry',
  'settings.toyLock.authClear': 'Clear',
  'settings.toyLock.authBackspace': 'Backspace',
  'settings.toyLock.authContinue': 'Continue',
  'settings.toyLock.authCancel': 'Cancel',
  'settings.toyLock.authInvalidPin': 'Enter 4 to 12 digits for the PIN.',
  'settings.toyLock.authRequired': 'Enter this factor before continuing.',
  'settings.toyLock.authRejected': 'This factor did not match.',
  'settings.toyLock.authVerificationFailed': 'This factor could not be checked. Try again when verification is available.',
  'settings.toyLock.authVerifying': 'Checking factor…',
  'settings.toyLock.editTabAppearance': 'Edit tab appearance…',
  'settings.toyLock.configure': 'Configure toy lock…',
  'settings.toyLock.lockElement': 'Lock this element…',
  'settings.toyLock.lockAgain': 'Lock again',
  'settings.toyLock.dropdownOpen': 'Open options',
  'settings.toyLock.choiceStatus': '{count} options, selected {label}',
  'settings.toyLock.qrLabel': 'Authenticator pairing QR code',
  'settings.toyLock.qrReveal': 'Show manual pairing secret',
  'settings.toyLock.qrHide': 'Hide manual pairing secret',
  'settings.toyLock.qrManual': 'Manual pairing secret',
  'settings.toyLock.qrUnavailable': 'Enter a valid uppercase Base32 secret to generate the local QR code.',
  'settings.toyLock.qrParameters': 'Local pairing uses otpauth, SHA1, six digits and a 30-second period.',
  'settings.toyLock.supportOpen': 'Forgot your password? Open Support Tickets',
  'settings.toyLock.supportTitle': 'Support Tickets',
  'settings.toyLock.supportDisclosure': 'Tickets stay on this device. They are not sent to a support team and nobody monitors them.',
  'settings.toyLock.supportSearch': 'Search local support tickets',
  'settings.toyLock.supportCategory': 'Category',
  'settings.toyLock.supportCategoryLockedOut': 'Locked out',
  'settings.toyLock.supportCategoryAuthenticator': 'Authenticator unavailable',
  'settings.toyLock.supportCategoryOther': 'Other local issue',
  'settings.toyLock.supportDescription': 'Description',
  'settings.toyLock.supportCreate': 'Create local ticket',
  'settings.toyLock.supportClose': 'Close Support Tickets',
  'settings.toyLock.supportSelectAll': 'Select all visible tickets',
  'settings.toyLock.supportInvert': 'Invert selection',
  'settings.toyLock.supportExport': 'Export selected tickets',
  'settings.toyLock.supportDismiss': 'Dismiss selected tickets',
  'settings.toyLock.supportEmpty': 'No local support tickets match this filter.',
  'settings.toyLock.supportStatus': 'Ticket {id}, dramatic severity, status: {status}.',
  'settings.toyLock.supportOpenFolder': 'Open application data folder',
  'settings.toyLock.supportFolderOpened': 'Application data folder opened. No data was deleted or reset.',
  'settings.toyLock.supportRecoveryPath': 'Recovery folder: {path}',
  'settings.toyLock.supportCopyPath': 'Copy recovery path',
  'settings.toyLock.supportPathCopied': 'Recovery path copied.',
  'settings.toyLock.supportPathCopyUnavailable': 'Clipboard unavailable. Select and copy the displayed recovery path manually.',
  'settings.toyLock.supportFolderFailed': 'The application data folder could not be opened. Nothing was deleted.',
  'settings.toyLock.supportResolution': 'Review the local recovery information and use the supported unlock flow. Opening the folder does not reset a lock.',
  'settings.toyLock.supportReviewDismiss': 'Dismiss {count} selected tickets. Review this count before continuing.',
  'settings.toyLock.supportReviewExport': 'Export {count} selected tickets from the filtered view. Review this count before continuing.',
  'settings.toyLock.supportReviewConfirm': 'Confirm action',
  'settings.toyLock.supportReviewCancel': 'Cancel action',
  'settings.toyLock.supportFirstResponse': 'Local guidance: review the recovery folder information. This is not a reply from a support team.',
  'settings.toyLock.supportMigration': '{count} older local tickets now include severity metadata and remain on this device.',
  'settings.toyLock.supportCollisionExhausted': 'No unique local ticket ID was available after five attempts. No ticket was created.',
  'settings.toyLock.tabAppearanceTitle': 'Edit tab appearance: {section}',
  'settings.toyLock.tabAppearanceClose': 'Close tab appearance editor',
  'settings.toyLock.tabAppearanceHint': 'Changes apply immediately to this settings tab and stay on this device.',
  'settings.toyLock.tabAppearanceSearch': 'Search appearance properties',
  'settings.toyLock.tabAppearanceColors': 'Text and background colors',
  'settings.toyLock.tabAppearanceTextColor': 'Text color',
  'settings.toyLock.tabAppearanceBackgroundColor': 'Background color',
  'settings.toyLock.tabAppearanceTypography': 'Typography',
  'settings.toyLock.tabAppearanceFontSize': 'Font size',
  'settings.toyLock.tabAppearanceFontWeight': 'Font weight',
  'settings.toyLock.tabAppearanceShape': 'Shape and corners',
  'settings.toyLock.tabAppearanceRadius': 'Corner radius',
  'settings.toyLock.tabAppearanceReset': 'Reset this tab appearance',
  'labs.pageDesc': 'Try local experimental features. Changes apply immediately and remain on this computer.',
  'labs.harnessName': 'Next-generation local strategy harness',
  'labs.itemAbout': 'About {name}',
  'labs.harnessTooltip': 'Uses the experimental local planning and execution harness for new runs.',
  'labs.harnessScope': 'This changes future local runs only. Existing runs are unchanged.',
  'labs.harnessHint': 'Turn this off if the experimental route is slower or produces worse results.',
  'labs.optOutPrompt': 'What made you turn this experiment off?',
  'labs.optOutWorseOutput': 'Worse output',
  'labs.optOutTooSlow': 'Too slow',
  'labs.optOutNotWhatIWanted': 'Not what I wanted',
  'labs.optOutOther': 'Other',
  'labs.optOutSkip': 'Skip',
  'labs.optOutOtherPlaceholder': 'Describe what happened',
  'labs.optOutSubmit': 'Send feedback',
  'labs.latchedNotice': 'This experiment was disabled by the local safety latch.',
  'labs.envOverrideNotice': 'An environment setting currently controls this experiment.',
  'labs.loadFailedNotice': 'The local experiment status could not be loaded.',
  ...
  'handoff.subtitle': 'A read-only, searchable inventory of the current design-token mappings and component owners.',
  'handoff.statusNote': 'Statuses describe source evidence only. The installed runtime and visual parity capture remain unverified for this lane.',
  'handoff.backToSettings': 'Back to Settings',
  'handoff.exportAria': 'Handoff copy and export actions',
  'handoff.exportLabel': 'Take this registry with you',
  'handoff.copySelected': 'Copy selected JSON',
  'handoff.copyAll': 'Copy all JSON',
  'handoff.downloadSucceeded': 'Handoff export downloaded',
  'handoff.downloadFailed': 'Handoff export could not be downloaded',
  'handoff.regexInvalid': '{field} has an invalid regex pattern; fix it or switch back to plain text.',
  'handoff.statusImplemented': 'Implemented',
  'handoff.statusPartial': 'Partial',
  'handoff.statusUnverified': 'Unverified',
  'handoff.exportSelected': 'Selected {format}',
  'handoff.exportAll': 'All {format}',
  'handoff.tokensTitle': '18 token mappings',
  'handoff.tokensDescription': 'The exact M3 token to application-variable seams used by this source tree.',
  'handoff.componentsTitle': '12 component owners',
  'handoff.componentsDescription': 'Current owners, source paths, and the honest state of their evidence.',
  'handoff.selectionCount': '{selected} selected · {visible} visible of {total}',
  'handoff.searchAria': 'Search {title}',
  'handoff.searchPlaceholder': 'Filter this list…',
  'handoff.bulkAria': 'Selection actions for {title}',
  'handoff.selectThisList': 'Select this list',
  'handoff.selectAllMatches': 'Select all matches',
  'handoff.invertSelection': 'Invert visible',
  'handoff.clearSelection': 'Clear selection',
  'handoff.noMatches': 'No matches in this registry list.',
  'handoff.selectRow': 'Select {id}',
  'handoff.swatchAria': 'Live color swatch for {variable}',
  'handoff.privacyNote': 'Exports use the v1 schema and omit private user data, credentials, machine paths, and runtime payloads. CSV is faithful for the fixed registry columns.',
  ...
  'chat.runError.title.cliSessionRefused': 'Local session refused',
  'chat.runError.title.membershipConcurrencyLimit': 'Too many active runs',
  'chat.runError.title.strategyTaskHalted': 'Strategy task stopped',
  ...
  'chat.runError.cliSessionRefusedMessage': 'The local command-line agent refused to create or resume this session. Check its local sign-in state, then retry.',
  'chat.runError.membershipConcurrencyLimitMessage': 'Your current membership has reached its active-run limit. Retry after {retryAt}.',
  'chat.runError.membershipConcurrencyLimitMessageNoTime': 'Your current membership has reached its active-run limit. Wait for another run to finish, then retry.',
  'chat.runError.strategyTaskStateMismatchMessage': 'The strategy task stopped before this continuation arrived. Retry the request or start a new task.',
  ...
  'chat.runError.cpuUnsupportedMessage': "This agent's runtime needs a CPU instruction set (AVX2) that this device doesn't have, so it can't start. Update Material Designer to the latest version, which ships a compatible runtime.",
  ...
  'chat.contextPrompt.referenceProject': 'Use the Material Designer project “{name}” as reference context. Its local path is: {path}. Before designing or modifying anything, search and read this directory when useful.',
  ...
  'libraryPicker.kindFilter': 'Filter library assets by kind',
  ...
  'settings.welcomeTitle': 'Welcome to Material Designer',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': 'Start from a brief',
  'settings.onboardingCreateBody': 'Describe the site, app, deck, image, or video you want. Material Designer will create a project and keep the work editable.',
  ...
  'settings.onboardingMemoryCalloutBody': 'These answers seed your Memory profile. Material Designer reuses it on every task — and keeps learning as you work.',
  ...
  'settings.onboardingCloudTitle': 'Welcome to Material Designer',
  'settings.onboardingCloudBody': 'Sign in to Material Designer through Open Design Cloud to start designing with cloud AI right away, no complex setup required.',
  'settings.onboardingCloudSignIn': 'Sign in to your cloud account to continue',
  ...
  'settings.agentInstall.pathHint': 'If you installed a CLI with npm or Homebrew and it still shows as not installed, ensure the tool\'s bin directory is on the PATH the Material Designer daemon inherits (Terminal vs GUI apps can differ on macOS). See QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Open Install or Docs for your preferred agent.',
  'settings.agentInstall.stepAuth': 'Authenticate with the vendor CLI (sign in or add API credentials) before returning to Material Designer.',
  ...
  'settings.mcpServerHint': 'Expose Material Designer as an MCP server for your coding agent.',
  ...
  'settings.searchResultsHeading': '{count} settings match',
  'settings.searchElsewhereNote': '{count} of them are on other tabs.',
  'settings.searchOtherTabBadge': 'On {section}',
  'settings.searchNoMatches': 'No settings match this search.',
  'settings.tabsAria': 'Settings sections',
  'settings.tabsOverflow': 'All settings sections',
  'settings.tabsOffscreen': 'Off screen',
  ...
  "settings.allowSilentUpdatesDesc": "When an in-app update is ready, install it automatically the next time Material Designer starts. Does not upgrade the current session. Installer updates still ask first.",
  ...
  'settings.updateQuitFailed': 'The installer opened, but Material Designer could not quit automatically.',
  ...
  'settings.mcpHint': 'Let coding agents (Cursor, Claude Code, VS Code…) read your Material Designer projects directly.',
  'settings.mcpDaemonError': 'Couldn\'t reach the local daemon to resolve install paths ({error}). Make sure Material Designer is running, then reopen this panel.',
  ...
  'settings.mcpCapabilityDefault': 'Default to the project and file you have open in Material Designer, so you can say "build this in my app" without re-stating which design.',
  'settings.mcpRunningNote': 'Material Designer must be running for MCP tool calls to succeed. If you started your coding agent before opening Material Designer, restart the agent so it can reach the live daemon.',
  ...
  'home.bundledScenarioMissing': 'The bundled scenario {scenarioId} is unavailable in this build.',
  ...
  'workingDirPicker.title': 'Select a code folder to link',
  ...
  'handoff.promptIntro': 'Continue from this local Material Designer project folder:',
  ...
  'pluginsHome.emptyCatalog': 'Catalog is empty. Bundled plugins ship with Material Designer and should appear here automatically — try restarting the daemon if this persists.',
  ...
  'integrations.lede': 'Connect external systems, bring MCP tools into your agent loop, and use Material Designer from other IDEs, scripts, and automations.',
  ...
  'mcpClient.daemonError': 'Could not reach the local daemon. Make sure Material Designer is running, then reopen this panel.',
  'mcpClient.saveFailed': 'Save failed. Check that the daemon is running and try again.',
  'useEverywhere.modalAria': 'Use Material Designer everywhere',
  'useEverywhere.modalTitle': 'Use Material Designer everywhere',
  'useEverywhere.modalSubtitle': 'Drop Material Designer into any IDE, agent, or script — CLI, HTTP, MCP, and Skills. Use “Copy guide for an agent” and paste into Claude Code, Codex, Cursor, openclaw, or hermes to set up everything.',
  ...
  'useEverywhere.section.overview.heading': 'Material Designer works wherever your agent works',
  'useEverywhere.section.overview.intro': 'Material Designer is more than a window — it is a local privileged daemon (`od`) plus a Skills + Design-Systems + Atoms registry. Once it is running on your machine, any code agent (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes, your own script) can drive generations, inspect projects, and produce design artifacts through four interchangeable surfaces.',
  'useEverywhere.section.overview.bullet1': 'CLI — `od <command>` for headless scripts, CI, and shell automation.',
  'useEverywhere.section.overview.bullet2': 'MCP server — wires Material Designer as a Model Context Protocol server so any MCP-capable agent can list skills, run scenarios, and read artifacts.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — drop-in `SKILL.md` packs (Claude-compatible) that any agent already on your PATH can invoke without Material Designer at all.',
  ...
  'useEverywhere.section.cli.heading': 'Drive Material Designer from any shell',
  ...
  'useEverywhere.section.mcp.heading': 'Expose Material Designer as an MCP server to any coding agent',
  'useEverywhere.section.mcp.intro': 'Material Designer ships with a Model Context Protocol server (`od mcp`) that lets any MCP-capable client — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — discover Material Designer tools (list skills, render previews, generate media, run plugins) without shelling out manually. The daemon publishes a ready-to-paste install snippet via `GET /api/mcp/install-info` for each major client.',
  ...
  'useEverywhere.section.mcp.footer': 'In the Material Designer app, open Settings → Integrations to copy a client-specific install command (Cursor, Claude Code, Antigravity, VS Code) instead of editing JSON by hand.',
  ...
  'useEverywhere.section.skills.heading': 'Drop-in Skills for any agent — even without Material Designer running',
  ...
  'newproj.locationDefault': 'Material Designer projects',
  ...
  'newproj.dsResults': '{count} platform options available',
  'newproj.desktopAgentLabel': 'Local agent for wire-up',
  'newproj.desktopAgentSearch': 'Search local agents',
  'newproj.desktopAgentResults': '{count} local agents found',
  'newproj.desktopAgentEmpty': 'No local agents match “{query}”.',
  'newproj.desktopAgentMissing': 'No selected local agent',
  'newproj.desktopAgentUnavailable': 'The selected local agent is unavailable',
  'newproj.desktopWireupToggle': 'Wire up after creation',
  'newproj.desktopWireupNotStarted': 'Not started. Creation will leave the scaffold ready.',
  'newproj.desktopWireupPromptLabel': 'Wire-up brief (optional)',
  ...
  'designs.filtersToggle': 'Filters & stats',
  'designs.filtersSummaryNone': '{n} projects · no filter active',
  'designs.filtersSummaryActive': '{n} projects · filter active: {label}',
  'designs.filterAll': 'All',
  'designs.filterPrototypes': 'Prototypes',
  'designs.filterDecks': 'Decks',
  'designs.filterMedia': 'Image & video',
  'designs.filterDocuments': 'Documents',
  ...
  'brandEnrichment.body': "Material Designer will run a deeper extraction in the background, apply the right design-system skills automatically, and update this system in place. This can take 10-20 minutes; you can keep working.",
  ...
  'chat.activeFilePlaceholder': 'Ask Material Designer to change {file}...',
  ...
  'chat.mode.design.solves': 'Use it when you want Material Designer to generate files, update the workspace, or turn a brief into multimodal deliverables.',
  ...
  'designBrowser.reference.kicker': 'Material Designer browser',
  ...
  'preview.shareTextDefault': 'Material Designer template: {title}',
  ...
  'preview.errorBody': 'The example HTML failed to fetch. Make sure Material Designer is running and try again.',
  'preview.retry': 'Retry',
  ...
  'designFiles.documentTemplate.goalBody': 'Describe what Material Designer should generate, edit, or decide from this document.',
  ...
  'designFiles.documentTemplate.capabilityAgent': 'The Material Designer agent can read, edit, and use this file as project context.',
  ...
  'designFiles.documentTemplate.nextBody': 'Review and edit this document, then ask Material Designer to generate, revise, or operate from it.',
  ...
  'fileViewer.exportDaemonUnreachable': 'The local service could not be reached. Start it or reconnect, then retry the export.',
  'fileViewer.exportZip': 'Download as .zip',
  'fileViewer.exportWebsiteHandoff': 'Export complete website handoff ZIP',
  'fileViewer.exportDesktopScaffold': 'Export desktop app scaffold',
  ...
  'questions.strategyBlockedNotice': 'The current strategy task must finish before these questions can be submitted.',
  ...
  'pet.tabBuiltInHint': 'Curated companions bundled with Material Designer — pick one and adopt.',
  ...
  'pet.codexBundledTitle': 'Ships with Material Designer — no download needed.',
  ...
  'settings.projectLocationsDescription': 'Add work bases that can contain multiple Material Designer project folders. New projects are saved as one folder inside the selected base.',
  ...
  'updater.availableBody': 'Material Designer {version} is available. It will download before the installer can open.',
  'updater.activeRunsTitle': 'Material Designer is still working',
  'updater.activeRunsBody': '{count} active tasks are still running. Restarting now will interrupt them.',
  'updater.activeRunsUnknownBody': 'Material Designer could not confirm whether tasks are still running. Restarting now may interrupt active work.',
  ...
  'updater.installerOpenBody': 'The installer is open. Material Designer is quitting so you can finish the update.',
  ...
  'updater.payloadReadyGeneric': 'A new Material Designer update is ready. Material Designer will close and restart automatically.',
  'updater.payloadReadyVersion': 'Material Designer {version} is ready. Material Designer will close and restart automatically.',
  'updater.quitButton': 'Quit Material Designer',
  'updater.quitFailedBody': 'The installer is open, but Material Designer could not quit. Quit Material Designer before replacing the app.',
  'updater.quitFailedTitle': 'Could not quit',
  'updater.quitting': 'Quitting...',
  'updater.ready': 'Update ready',
  'updater.readyGeneric': 'A new version is ready. Material Designer will close and open the installer.',
  'updater.readyVersion': 'Material Designer {version} is ready. Material Designer will close and open the installer.',
  'updater.reinstallLearnMore': 'Learn more',
  'updater.reinstallReadyGeneric': 'This update requires a full reinstall. Material Designer will close and open the installer.',
  'updater.reinstallReadyVersion': 'Material Designer {version} requires a full reinstall. Material Designer will close and open the installer.',
  ...
  'automations.enabledSwitchAria': '{name} enabled',
  ...
  'dsManager.createBody': 'Teach Material Designer your brand, product, code, assets, and design references.',
  ...
  'settings.customInstructionsDesc': 'Fixed instructions Material Designer follows in every chat. These are not saved memories; use Memory for facts, preferences, and project context.',
  ...
  'brand.librarySubtitle': 'Teach Material Designer your design systems — extract one from a website, then apply it in any chat.',
  ...
  'appLogo.title': 'App logo',
  'appLogo.hint': 'Choose a bundled mark or select a local image. The mark changes presentation only, never application identity.',
  'appLogo.reset': 'Reset logo',
  'appLogo.search': 'Search logo presets',
  'appLogo.presets': 'Logo presets',
  'appLogo.material': 'Material mark',
  'appLogo.warm': 'Warm mark',
  'appLogo.monochrome': 'Monochrome mark',
  'appLogo.outline': 'Outline mark',
  'appLogo.uploadHelp': 'Static PNG, JPEG, or WebP only. Maximum source size is 8 MiB; animated, malformed, oversized, and multi-frame input is refused before decoding.',
  'appLogo.upload': 'Choose a local logo image',
  'appLogo.fit': 'Fit mode',
  'appLogo.contain': 'Contain',
  'appLogo.cover': 'Cover',
  'appLogo.fill': 'Fill',
  'appLogo.focalX': 'Focal point X',
  'appLogo.focalY': 'Focal point Y',
  'appLogo.safeArea': 'Show safe-area preview',
  'appLogo.transparent': 'Transparent background',
  'appLogo.rainbow': 'Animated rainbow background',
  'appLogo.rainbowSpeed': 'Rainbow speed level, 1 is fastest and 5 is slowest',
  'appLogo.background': 'Logo background colour',
  'appLogo.crop': 'Crop, normalized 0–1',
  'appLogo.targets': 'Display-target previews',
  'appLogo.selectedPreview': 'Selected application logo preview',
  'appLogo.staticPreset': 'Bundled local preset',
  'appLogo.alphaPreserved': 'alpha preserved',
  'appLogo.sourceAlpha': 'source includes transparency',
  'appLogo.sourceOpaque': 'source is opaque',
  'appLogo.opaque': 'opaque source',
  'appLogo.frame': '1 frame',
  'appLogo.validating': 'Validating the selected image locally…',
  'appLogo.converted': 'Converted locally to a verified {width}×{height} PNG ({bytes} bytes).',
  ...
  'appLogo.lossDisclosure': 'Source disclosure: {losses} are not retained by the converted PNG. The source remains unchanged.',
  'appLogo.schedule': 'Scheduled logo appearance',
  'appLogo.scheduleHint': 'Use local date and time values. Matching rules apply temporarily and never rewrite the base selection.',
  'appLogo.scheduleStart': 'Starts',
  'appLogo.scheduleEnd': 'Ends',
  'appLogo.schedulePreset': 'Scheduled preset',
  'appLogo.scheduleLabel': 'Schedule label',
  'appLogo.scheduleWeekdays': 'Weekdays',
  'appLogo.scheduleEnabled': 'Enabled',
  'appLogo.scheduleDelete': 'Delete schedule',
  'appLogo.scheduleEdit': 'Edit schedule',
  'appLogo.sun': 'Sun', 'appLogo.mon': 'Mon', 'appLogo.tue': 'Tue', 'appLogo.wed': 'Wed', 'appLogo.thu': 'Thu', 'appLogo.fri': 'Fri', 'appLogo.sat': 'Sat',
  'appLogo.scheduleAdd': 'Add schedule',
  'appLogo.scheduleAdded': 'Logo schedule added locally.',
  'appLogo.scheduleInvalid': 'Enter a valid start and end, with the end after the start.',
  'appLogo.noMatch': 'No matching option.',
  'appLogo.timezone': 'Timezone: {timezone}. Daylight-saving changes follow the platform clock.',
  'appLogo.lossBefore': 'Before activation, conversion may omit the source format, metadata, colour profile, cropped pixels, or transparency when an opaque background is chosen. The original file stays unchanged.',
  'appLogo.targetFavicon': 'Favicon',
  'appLogo.targetToolbar': 'Toolbar',
  'appLogo.targetTitlebar': 'Title bar',
  'appLogo.targetSidebar': 'Sidebar',
  'appLogo.targetInstaller': 'Installer',
  'appLogo.installerPreviewOnly': 'Installer preview only: this mark does not change package identity, installer identity, update feed, or signing state.',
  ...
  'onboarding.buildBody': 'Material Designer turns your brand into a reusable design system — then keeps everything you build on-brand and consistent.',
  ...
  'dsCreate.sourceSectionBody': 'Start with a GitHub repo, website, DESIGN.md, or files that show your style. Material Designer first creates a usable system quickly, then AI can refine it inside the project.',
  ...
  'dsCreate.figmaInvalidFile': 'That isn’t a .fig file. Export your Figma file as .fig (File → Save local copy) and drop it here.',
  'dsCreate.figmaProjectUnavailable': 'Could not open a project to import into. Try again.',
  'dsCreate.figmaImportFailed': 'The Figma import could not start. Check the project connection and try again.',
  'dsCreate.figmaInvalidUrl': 'Enter a Figma file URL (https://figma.com/file/… or /design/…).',
  'dsCreate.figmaImportAction': 'Import & build',
  'dsCreate.figmaDecoding': 'Decoding…',
  'dsCreate.figmaImporting': 'Importing…',
  'dsCreate.figmaImported': 'Imported',
  'dsCreate.figmaAssetsOnly': 'assets only — the node tree could not be decoded',
  'dsCreate.figmaNodes': 'nodes',
  'dsCreate.figmaPages': 'pages',
  'dsCreate.figmaFrames': 'frames',
  'dsCreate.figmaComponents': 'components',
  'dsCreate.figmaColors': 'colors',
  'dsCreate.figmaFonts': 'fonts',
  'dsCreate.figmaAssets': 'assets',
  'dsCreate.figmaColorTokens': 'Color tokens',
  'dsCreate.figmaSummaryFoot': 'The prompt is ready in the composer — review and send to build the page.',
  'dsCreate.back': 'Back',
  ...
  'ds.extractionRunningBody': 'Material Designer is updating this system in place.',
  ...
  'ds.repoConnectBannerBody': 'Connect GitHub so Material Designer can read your repository and pull colors, type, and components into this design system.',
  ...
  'settings.languageModeTitle': 'Display mode',
  'settings.languageModeHint': 'Show one language, or two at once.',
  'settings.languageModeSingle': 'One language',
  'settings.languageModeBilingual': 'Bilingual',
  'settings.languageModeBilingualHint': 'Bilingual shows the language you picked and English together — or 廣東話 when the language you picked is English.',
  'settings.funnyTitle': 'Personality',
  'settings.funnyHint': 'How playful the wording gets. Set separately for each language.',
  'settings.funnyFactsNotice': 'Wording only. Numbers, versions, file paths, licence terms, and warnings about what an action will do are identical at every level.',
  'settings.funnyEnglishLabel': 'English',
  'settings.funnyCantoneseLabel': 'Cantonese · 廣東話',
  'settings.funnyLevel1': 'Straight',
  'settings.funnyLevel2': 'Warm',
  'settings.funnyLevel3': 'Playful',
  'settings.funnyLevel4': 'Cheeky',
  'settings.funnyLevel5': 'Yum cha',
  'settings.funnyLevelValue': 'Level {level} · {name}',
  'settings.funnyDisclosureTitle': 'This app has a sense of humour, and you hold the dial',
  'settings.funnyDisclosureBody': 'Buttons, empty states, and error messages can read straight or playful, per language. The dial lives in Settings → Language, and it only ever changes the wording — never a number, a path, or what a button is about to do.',
  'settings.funnyDisclosureDismiss': 'Got it',

  // Regex search field: the affordance beside a search bar, and what it tells assistive
  // technology about the mode in force.
  'regexSearch.toggleAria': 'Regex options for the {field} search',
  'regexSearch.toggleTitleText': 'Matching plain text — open the regex builder',
  ...
  'regexBuilder.title': 'Regex builder',
  'regexBuilder.nonModal': 'non-modal',
  'regexBuilder.forField': 'for {field}',
  'regexBuilder.engineNote': 'Patterns run on {engine} — the same engine this search uses.',
  'regexBuilder.modeLegend': 'Match with',
  'regexBuilder.modePlain': 'Plain text',
  'regexBuilder.modeRegex': 'Regular expression',
  'regexBuilder.plainNotice': 'This field matches plain text, ignoring case. Turn on the regular expression to build a pattern.',
  'regexBuilder.enableRegex': 'Use a regular expression',
  'regexBuilder.patternLabel': 'Pattern',
  'regexBuilder.patternPlaceholder': 'Type a pattern, or add parts below',
  'regexBuilder.patternLength': '{length} of {limit} characters',
  'regexBuilder.errorHeading': '{engine} rejected this pattern',
  'regexBuilder.errorTooLong': 'The pattern is {length} characters; the limit is {limit}.',
  'regexBuilder.usingLastValid': 'Still searching with the last pattern that compiled.',
  'regexBuilder.slowShape': 'A repeat inside a repeat is the usual cause of a runaway match. Keep the sample short while you try it.',
  'regexBuilder.copyPattern': 'Copy pattern',
  'regexBuilder.copyLiteral': 'Copy as /pattern/flags',
  'regexBuilder.copied': 'Copied',
  'regexBuilder.copyFailed': 'Could not copy',
  'regexBuilder.escapeAsLiteral': 'Escape this text so it matches literally',
  'regexBuilder.flagsLegend': 'Flags',
  'regexBuilder.flagG': 'g — keep going after the first match instead of stopping',
  'regexBuilder.flagI': 'i — ignore upper and lower case',
  'regexBuilder.flagM': 'm — ^ and $ match at every line, not only the whole text',
  'regexBuilder.flagS': 's — let . match a newline as well',
  'regexBuilder.flagU': 'u — read the pattern as Unicode code points',
  'regexBuilder.flagY': 'y — match only where the previous match ended',
  'regexBuilder.partsLegend': 'Guided parts',
  'regexBuilder.partsEmpty': 'No parts yet. Add one and the pattern above writes itself.',
  'regexBuilder.addPartLegend': 'Add a part',
  'regexBuilder.addLiteral': 'Text',
  'regexBuilder.addCharClass': 'Character class',
  'regexBuilder.addAnchor': 'Anchor',
  'regexBuilder.addGroup': 'Group',
  'regexBuilder.addAlternation': 'Any of',
  'regexBuilder.outOfSyncTitle': 'Beyond the guided parts',
  'regexBuilder.outOfSyncBody': 'The pattern uses {token} at position {at}, which the parts below cannot represent. Your pattern is kept exactly as you typed it and still runs; only the parts step back.',
  'regexBuilder.outOfSyncTooLong': 'The pattern is longer than {limit} characters, so it is not being broken into parts.',
  'regexBuilder.outOfSyncAction': 'Discard the typed pattern and build from parts',
  'regexBuilder.partLiteral': 'Text',
  'regexBuilder.partCharClass': 'Character class',
  'regexBuilder.partAnchor': 'Anchor',
  'regexBuilder.partGroup': 'Group',
  'regexBuilder.partAlternation': 'Any of',
  'regexBuilder.movePartUp': 'Move up',
  'regexBuilder.movePartDown': 'Move down',
  'regexBuilder.removePart': 'Remove this part',
  'regexBuilder.literalValueLabel': 'Text to match',
  'regexBuilder.literalHint': 'Typed as text; every regex character is escaped for you.',
  'regexBuilder.classPresetLabel': 'Class',
  'regexBuilder.classDigit': 'Any digit',
  'regexBuilder.classNotDigit': 'Anything but a digit',
  'regexBuilder.classWord': 'Letter, digit or underscore',
  'regexBuilder.classNotWord': 'Not a letter, digit or underscore',
  'regexBuilder.classWhitespace': 'Whitespace',
  'regexBuilder.classNotWhitespace': 'Not whitespace',
  'regexBuilder.classAny': 'Any character',
  'regexBuilder.classCustom': 'Custom set',
  'regexBuilder.classCustomLabel': 'Set contents',
  'regexBuilder.classCustomHint': 'Class contents, so a-z0-9_ stays a range set.',
  'regexBuilder.classNegate': 'Match anything NOT in the set',
  'regexBuilder.anchorLabel': 'Anchor',
  'regexBuilder.anchorStart': 'Start of the text',
  'regexBuilder.anchorEnd': 'End of the text',
  'regexBuilder.anchorWordBoundary': 'Word boundary',
  'regexBuilder.anchorNotWordBoundary': 'Not a word boundary',
  'regexBuilder.groupKindLabel': 'Group kind',
  'regexBuilder.groupCapturing': 'Capturing',
  'regexBuilder.groupNonCapturing': 'Non-capturing',
  'regexBuilder.groupNamed': 'Named',
  'regexBuilder.groupNameLabel': 'Name',
  'regexBuilder.groupBodyLabel': 'Group body',
  'regexBuilder.groupBodyHint': 'Raw pattern source — this one is not escaped for you.',
  'regexBuilder.alternationHint': 'Each option is matched as text and escaped for you.',
  'regexBuilder.alternationOptionLabel': 'Option {index}',
  'regexBuilder.alternationAdd': 'Add an option',
  'regexBuilder.alternationRemove': 'Remove option {index}',
  'regexBuilder.quantifierLabel': 'Repeat',
  'regexBuilder.quantifierOne': 'Exactly once',
  'regexBuilder.quantifierOptional': 'Optional (0 or 1)',
  'regexBuilder.quantifierStar': 'Any number (0 or more)',
  'regexBuilder.quantifierPlus': 'One or more',
  'regexBuilder.quantifierExactly': 'Exactly n times',
  'regexBuilder.quantifierAtLeast': 'n times or more',
  'regexBuilder.quantifierBetween': 'Between n and m times',
  'regexBuilder.quantifierMin': 'Least',
  'regexBuilder.quantifierMax': 'Most',
  'regexBuilder.quantifierLazy': 'As few as possible',
  'regexBuilder.quantifierLazyHint': 'Adds ? so the repeat stops at the first thing that works.',
  'regexBuilder.sampleLegend': 'Sample text',
  'regexBuilder.samplePlaceholder': 'Paste something to try the pattern on',
  'regexBuilder.sampleEmpty': 'Add some sample text to see what this matches.',
  'regexBuilder.sampleTruncated': 'Only the first {limit} characters of the sample are being matched.',
  'regexBuilder.matchCount': '{count} matches',
  'regexBuilder.matchCountOne': '1 match',
  'regexBuilder.matchNone': 'No matches.',
  'regexBuilder.matchesTruncated': 'Stopped after {limit} matches.',
  'regexBuilder.matchesTimedOut': 'Stopped early — this pattern is slow on this sample.',
  'regexBuilder.previewLabel': 'Match preview',
  'regexBuilder.groupsLegend': 'Capture groups',
  'regexBuilder.groupsNone': 'This pattern has no capture groups.',
  'regexBuilder.colMatch': 'Match',
  'regexBuilder.colGroup': 'Group',
  'regexBuilder.colName': 'Name',
  'regexBuilder.colValue': 'Value',
  'regexBuilder.groupUnmatched': 'did not participate',
   'regexBuilder.safetyNote': 'Patterns and samples are capped, and matching stops early if it gets slow. One runaway match still cannot be interrupted, so keep the sample small when trying an unfamiliar pattern.',
   'regexBuilder.constructColumn': 'Construct',
   'regexBuilder.statusColumn': 'Status',
   'regexBuilder.exampleColumn': 'Example',
   'regexBuilder.reasonColumn': 'Reason',
   'regexBuilder.sourceColumn': 'Source',
   'regexBuilder.rangeColumn': 'Range',
   'regexBuilder.meaningColumn': 'Meaning',
   'regexBuilder.reviewLabel': 'review',
   'regexBuilder.workbenchHint': 'These inserts append raw engine syntax to this pattern field. The raw editor stays authoritative when a construct cannot be represented by guided parts.',
   'regexBuilder.replacementHint': 'Supports $$, $&, $1–$99, $<name>, $` and $\'. Input and output are bounded locally.',
   'regexBuilder.replacementEmpty': '(empty output)',
   'regexBuilder.replacementStatus': '{count} replacement(s)',
   'regexBuilder.replacementUnavailable': 'Replacement preview is unavailable until the pattern compiles.',
   'regexBuilder.replacementTimedOut': 'Replacement preview stopped at the local safety budget.',
   'regexBuilder.profileElapsed': 'Elapsed: {value} ms',
   'regexBuilder.profileTokens': 'Tokens: {value}',
   'regexBuilder.profileMatches': 'Matches: {value}',
   'regexBuilder.profileSample': 'Sample: {value} characters',
   'regexBuilder.traceNote': 'Bounded trace: this engine does not expose backtracking events. The workbench shows structural token details and stops at its local profiling limit instead of inventing an execution trace.',
   'regexBuilder.snippetHint': 'Saving is explicit and local. Sample text is never included in a snippet.',
   'regexBuilder.snippetName': 'Snippet name',
   'regexBuilder.snippetSave': 'Save',
   'regexBuilder.snippetCopy': 'Copy JSON',
   'regexBuilder.snippetExport': 'Export JSON',
   'regexBuilder.snippetImport': 'Import JSON',
   'regexBuilder.snippetsCopied': 'Snippets copied',
   'regexBuilder.snippetSaved': 'Snippet saved locally',
   'regexBuilder.snippetsImported': 'Snippets imported locally',
   'regexBuilder.snippetsEmpty': 'No snippets saved in this builder.',
   'regexBuilder.evaluationRefused': 'Evaluation refused before the engine ran: {reason}',
   'regexBuilder.evaluationExhausted': 'Evaluation stopped at the local safety budget. The visible result set is not filtered further.',
   'regexBuilder.highRiskReason': 'The conservative safety parser found nested backtracking risk before evaluation.',
   'regexBuilder.snippetImportFailed': 'The snippet file could not be imported because its schema or contents were invalid.',
   'regexBuilder.unicodeCodePoint': 'Unicode code point',
   'regexBuilder.unicodeCodePointHint': 'Insert a Unicode code-point escape. Enable the u flag for code-point matching.',
   'regexBuilder.matchPrevious': 'Previous match',
   'regexBuilder.matchNext': 'Next match',
   'regexBuilder.matchPosition': 'Match {current} of {total}',
   'regexBuilder.caseExpectedMatch': 'Expected match',
   'regexBuilder.caseExpectedNoMatch': 'Expected no match',
   'regexBuilder.caseActualMatch': 'Matched',
   'regexBuilder.caseActualNoMatch': 'Did not match',
   'regexBuilder.caseRefused': 'Refused before evaluation',
   'regexBuilder.caseTimedOut': 'Stopped at the local budget',
   'regexBuilder.caseAdd': 'Add test case',
   'regexBuilder.caseInput': 'Test input',
   'regexBuilder.caseExpected': 'Expected result',
   'regexBuilder.caseSuite': 'Expected match and no-match cases',
   'regexBuilder.caseEmpty': 'No test cases saved in this workbench.',
   'regexBuilder.errorUnsafe': 'This pattern was refused before evaluation because it may cause unbounded backtracking: {reason}',
   'regexBuilder.capabilityLiteral': 'Literal text',
   'regexBuilder.capabilityUnicodeCodePoint': 'Unicode code points',
   'regexBuilder.capabilityCharacterClass': 'Character classes',
   'regexBuilder.capabilityClassIntersection': 'Class intersection and subtraction',
   'regexBuilder.capabilityAnchors': 'Anchors and boundaries',
   'regexBuilder.capabilityCaptureGroups': 'Capturing and named groups',
   'regexBuilder.capabilityNonCapturingGroups': 'Non-capturing groups',
   'regexBuilder.capabilityAlternation': 'Alternation',
   'regexBuilder.capabilityQuantifiers': 'Greedy and lazy quantifiers',
   'regexBuilder.capabilityLookaround': 'Lookahead and lookbehind',
   'regexBuilder.capabilityBackreferences': 'Numbered and named backreferences',
   'regexBuilder.capabilityUnicodeProperties': 'Unicode property escapes',
   'regexBuilder.capabilityInlineModifiers': 'Inline modifiers',
   'regexBuilder.capabilityAtomicGroups': 'Atomic groups',
   'regexBuilder.capabilityPossessiveQuantifiers': 'Possessive quantifiers',
   'regexBuilder.capabilityConditionals': 'Conditional groups',
   'regexBuilder.capabilitySubroutines': 'Subroutines and recursion',
   'regexBuilder.capabilityReplacementTemplates': 'Replacement templates',
   'regexBuilder.reasonLiteral': 'Escaped and unescaped literal characters are supported by JavaScript RegExp.',
   'regexBuilder.reasonUnicodeCodePoint': 'Code-point escapes are supported when the u or v flag is active; the builder preserves the exact escape.',
   'regexBuilder.reasonCharacterClass': 'Bracket classes and JavaScript shorthand classes are supported.',
   'regexBuilder.reasonClassIntersection': 'This JavaScript RegExp dialect does not expose set-notation intersection or subtraction.',
   'regexBuilder.reasonAnchors': 'Start, end, word-boundary, and line anchors are supported through the active flags.',
   'regexBuilder.reasonCaptureGroups': 'Numbered and named captures are returned by the engine.',
   'regexBuilder.reasonNonCapturingGroups': 'Non-capturing grouping is supported.',
   'regexBuilder.reasonAlternation': 'The engine supports alternation with the vertical bar.',
   'regexBuilder.reasonQuantifiers': 'The active engine supports greedy, lazy, and bounded quantifiers.',
   'regexBuilder.reasonLookaround': 'The active JavaScript engine supports positive and negative lookaround.',
   'regexBuilder.reasonBackreferences': 'Backreferences are supported by the active engine and retain capture semantics.',
   'regexBuilder.reasonUnicodeProperties': 'Supported when the u or v flag is active and the host engine supports the property.',
   'regexBuilder.reasonInlineModifiers': 'This JavaScript dialect has no inline flag-group syntax; use the workbench flag controls instead.',
   'regexBuilder.reasonAtomicGroups': 'Atomic groups are not part of the JavaScript RegExp syntax exposed here.',
   'regexBuilder.reasonPossessiveQuantifiers': 'Possessive quantifiers are not part of the JavaScript RegExp syntax exposed here.',
   'regexBuilder.reasonConditionals': 'Conditional groups are not supported by JavaScript RegExp.',
   'regexBuilder.reasonSubroutines': 'Subroutine and recursive calls are not supported by JavaScript RegExp.',
   'regexBuilder.reasonReplacementTemplates': 'Replacement templates are expanded locally with bounded input and output.',
   'regexBuilder.summaryUnsupported': '{count} construct(s) need attention because this engine cannot run them.',
   'regexBuilder.summaryConditional': '{tokens} token(s) explained; {count} construct(s) depend on flags or deserve a performance review.',
   'regexBuilder.summarySupported': '{tokens} token(s) explained by the active JavaScript RegExp dialect.',
   'regexBuilder.tokenLiteral': 'Literal',
   'regexBuilder.tokenLiteralExplanation': 'Matches this character literally.',
   'regexBuilder.tokenEscape': 'Escape',
   'regexBuilder.tokenEscapeExplanation': 'The escaped sequence has engine-defined meaning rather than literal text.',
   'regexBuilder.tokenUnicodeProperty': 'Unicode property escape',
   'regexBuilder.tokenUnicodePropertyExplanation': 'Matches a Unicode property when the host supports it and the u or v flag is active.',
   'regexBuilder.tokenUnicodeCodePoint': 'Unicode code point',
   'regexBuilder.tokenUnicodeCodePointExplanation': 'Matches the exact Unicode code point when the u or v flag is active.',
   'regexBuilder.tokenBackreference': 'Backreference',
   'regexBuilder.tokenBackreferenceExplanation': 'Reuses text captured by an earlier group.',
   'regexBuilder.tokenCharacterClass': 'Character class',
   'regexBuilder.tokenCharacterClassExplanation': 'Matches one character from the class, with optional negation and ranges.',
   'regexBuilder.tokenClassSetNotation': 'Class set notation',
   'regexBuilder.tokenClassSetNotationExplanation': 'Intersection and subtraction are not available in this dialect.',
   'regexBuilder.tokenCapturingGroup': 'Capturing group',
   'regexBuilder.tokenCapturingGroupExplanation': 'Captures the enclosed text by number.',
   'regexBuilder.tokenGroupEnd': 'Group end',
   'regexBuilder.tokenGroupEndExplanation': 'Ends the nearest open group.',
   'regexBuilder.tokenAlternation': 'Alternation',
   'regexBuilder.tokenAlternationExplanation': 'Chooses between the expression on the left and the expression on the right.',
   'regexBuilder.tokenAnchor': 'Anchor',
   'regexBuilder.tokenAnchorExplanation': 'Constrains where a match can begin or end.',
   'regexBuilder.tokenWildcard': 'Wildcard',
   'regexBuilder.tokenWildcardExplanation': 'Matches a character, except line terminators unless the s flag is active.',
   'regexBuilder.tokenQuantifier': 'Quantifier',
   'regexBuilder.tokenQuantifierExplanation': 'Repeats the preceding atom. A trailing ? requests the shortest permitted match.',
   'regexBuilder.tokenPossessive': 'Possessive quantifier',
   'regexBuilder.tokenPossessiveExplanation': 'Possessive quantifiers are not supported by JavaScript RegExp.',
   'regexBuilder.tokenNamedCapture': 'Named capture {name}',
   'regexBuilder.tokenLookahead': 'Lookahead',
   'regexBuilder.tokenLookbehind': 'Lookbehind',
   'regexBuilder.tokenInlineModifier': 'Inline modifier',
   'regexBuilder.tokenAtomicGroup': 'Atomic group',
   'regexBuilder.tokenSubroutine': 'Subroutine',
   'regexBuilder.tokenConditionalGroup': 'Conditional group',
   'regexBuilder.tokenUnsupportedGroup': 'Unsupported group construct',
   'regexBuilder.tokenGenericExplanation': 'This construct is described by the active engine capability matrix.',
   'regexBuilder.statusSupported': 'Supported',
   'regexBuilder.statusConditional': 'Conditional',
   'regexBuilder.statusUnsupported': 'Unsupported',
   'regexBuilder.snippetFileTooLarge': 'Snippet file is larger than the local byte limit.',
   'regexBuilder.snippetFileInvalid': 'Snippet file is not valid UTF-8 JSON.',
   'regexBuilder.snippetPersistFailed': 'Snippets could not be saved locally. The current editor state remains active.',
   'regexBuilder.engineVersion': '{version} · flags {flags}',
   'regexBuilder.versionUnavailable': '(runtime version unavailable)',
   'regexBuilder.versionFromUserAgent': '(version detected from the host user agent)',
   'regexBuilder.tokenAnnotations': 'Token annotations',
   'regexBuilder.tokenEmpty': 'Type a pattern to see its token annotations.',
   'regexBuilder.advancedConstructs': 'Guided advanced constructs',
   'regexBuilder.replacementAndProfile': 'Replacement preview and profiling',
   'regexBuilder.replacementTemplate': 'Replacement template',
   'regexBuilder.outputTruncated': 'output truncated at the local limit',
   'regexBuilder.savedSnippets': 'Saved snippets',

  // Dim sum surprise: the line of copy under the dish's own name.
  'dimSum.blurb': 'A little something from the tea house. It will see itself out.',

  // Changelog viewer: every recorded version, the typed/calendar date filter, the scope
  // sentence and the export.
  'changelog.title': 'Changelog',
  'changelog.subtitle': 'Every version this build records, and the commit behind each change.',
  'changelog.openButton': 'Open changelog',
  'changelog.settingsHint': 'Every version, with its date, its changes and the commit behind each one.',
  'changelog.searchLabel': 'Search',
  'changelog.searchPlaceholder': 'Search every version…',
  'changelog.dateFrom': 'From',
  'changelog.datePresetAll': 'All time',
  'changelog.dateTo': 'To',
  'changelog.datePlaceholder': 'YYYY-MM-DD',
  'changelog.dateHint': 'Type a date, or pick a range from the calendar.',
  'changelog.dateOpenAria': 'Open the calendar',
  'changelog.dateRangeBackwards': 'The end of the range is before its start.',
  'changelog.datePartialFields': 'Still incomplete — a date needs a year, a month and a day.',
  'changelog.datePartialYear': 'The year needs four digits.',
  'changelog.dateInvalidShape': 'That is not a date. Nothing has been cleared — fix it or empty the field.',
  'changelog.dateInvalidRange': 'There is no such day.',
  'changelog.calendarAria': 'Calendar',
  'changelog.monthLabel': 'Month',
  'changelog.yearLabel': 'Year',
  'changelog.prevMonth': 'Previous month',
  'changelog.nextMonth': 'Next month',
  'changelog.pickStart': 'Pick the start of the range.',
  'changelog.pickEnd': 'Now pick the end.',
  'changelog.scopeAll': 'All {matched} changes, across {versions} versions.',
  'changelog.scopeFiltered': '{matched} of {total} changes.',
  'changelog.scopeSearch': 'matching “{query}”',
  'changelog.scopeRange': 'dated {from} to {to}',
  'changelog.scopeRangeFrom': 'dated {from} onwards',
  'changelog.scopeRangeTo': 'dated up to {to}',
  'changelog.scopeUndated': '{count} changes have no commit to date them and fall outside the range.',
  'changelog.empty': 'Nothing in the changelog matches that.',
  'changelog.emptyHint': 'Clear the search, or widen the dates.',
  'changelog.releaseDateSource': 'released {date}',
  'changelog.releaseDateCommits': 'latest change {date}',
  'changelog.releaseDateUnknown': 'no date recorded',
  'changelog.entryCount': '{count} changes',
  'changelog.sourceLabel': 'from {path}',
  'changelog.commitLinkAria': 'Open commit {sha}',
  'changelog.commitSummarizes': 'summarizes {count} commits',
  'changelog.commitUnrecorded': 'no commit recorded for this entry',
  'changelog.commitUnresolved': 'the commit this entry names is not in this repository',
  'changelog.copy': 'Copy',
  'changelog.copied': 'Copied what is on screen.',
  'changelog.copyFailed': 'Could not copy — select the text and copy it by hand.',
  'changelog.exportMarkdown': 'Export Markdown',
  'changelog.exportText': 'Export text',
  'changelog.exported': 'Saved {filename}',

  // Command palette: scopes, groups, commands and destinations.
  'commandPalette.title': 'Command palette',
  'commandPalette.placeholder': 'Search commands, settings and places…',
  'commandPalette.noResults': 'Nothing matches that.',
  'commandPalette.filesUnavailable': 'Open a project to search its files and tabs.',
  'commandPalette.scopeLabel': 'Search scope',
  'commandPalette.scopeAll': 'Everything',
  'commandPalette.scopeCommands': 'Commands',
  'commandPalette.scopeSettings': 'Settings',
  'commandPalette.scopeGo': 'Go to',
  'commandPalette.scopeFiles': 'Files and tabs',
  'commandPalette.groupCommands': 'Commands',
  'commandPalette.groupGo': 'Go to',
  'commandPalette.groupSettings': 'Settings',
  'commandPalette.groupFiles': 'Files and tabs',
  'commandPalette.commandSearchFiles': 'Search files and tabs',
  'commandPalette.commandSearchFilesHint': 'The quick switcher, inside the palette',
  'commandPalette.commandNewTab': 'New workspace tab',
  'commandPalette.commandFullWindow': 'Use the full window',
  'commandPalette.commandExitFullWindow': 'Back to the card',
  'commandPalette.commandFullWindowHint': 'The size is remembered for next time',
  'commandPalette.commandCycleTheme': 'Switch theme',
  ...
  'workspaceTabs.pin': 'Pin tab',
  'workspaceTabs.unpin': 'Unpin tab',
  'workspaceTabs.permanentTab': 'This tab is permanent and cannot be closed.',
  'workspaceTabs.matchMode': 'Match mode',
  'workspaceTabs.bulkCloseTitle': 'Close tabs by text',
  'workspaceTabs.bulkCloseQueryLabel': 'Text to match in tab names',
  'workspaceTabs.bulkCloseModeText': 'Plain text',
  'workspaceTabs.bulkCloseModeRegex': 'Regex',
  'workspaceTabs.bulkCloseCaseSensitive': 'Match case',
  'workspaceTabs.bulkCloseIncludePinned': 'Include pinned',
  'workspaceTabs.bulkCloseContaining': 'Containing',
  'workspaceTabs.bulkCloseNotContaining': 'Not containing',
  'workspaceTabs.bulkClosePreview': '{count} tabs will close',
  'workspaceTabs.bulkCloseMore': 'and {count} more',
  'workspaceTabs.bulkCloseExcludedPinned': '{count} pinned tabs are excluded',
  'workspaceTabs.bulkCloseExcludedPermanent': '{count} permanent tabs are excluded',
  'workspaceTabs.bulkCloseEmptyQuery': 'Type something to match. Nothing closes on an empty query.',
  'workspaceTabs.bulkCloseInvalidPattern': 'That pattern does not compile: {detail}',
  'workspaceTabs.bulkCloseTooLong': 'That query is too long to run safely.',
  'workspaceTabs.bulkCloseNoMatches': 'No tab names match.',
  'workspaceTabs.bulkCloseConfirm': 'Close {count} tabs',
  'workspaceTabs.groupUntitled': 'Untitled group',
  'workspaceTabs.groupNew': 'New group',
  'workspaceTabs.groupNewFromTab': 'New group with this tab',
  'workspaceTabs.groupNone': 'No group',
  'workspaceTabs.groupNoneYet': 'No groups yet. Create one to file tabs together.',
  'workspaceTabs.groupRemove': 'Remove group',
  'workspaceTabs.groupRemoveTab': 'Take this tab out of the group',
  'workspaceTabs.groupAddTab': 'Add a tab',
  'workspaceTabs.groupAddTabPlaceholder': 'Choose a tab…',
  'workspaceTabs.groupCollapse': 'Collapse group',
  'workspaceTabs.groupExpand': 'Expand group',
  'workspaceTabs.groupMoveEarlier': 'Move group earlier',
  'workspaceTabs.groupMoveLater': 'Move group later',
  'workspaceTabs.groupMoveTabHeading': 'Move to group',
  'workspaceTabs.groupRenameLabel': 'Group name',
  'workspaceTabs.groupTabCount': '{count} tabs',
  'workspaceTabs.groupEmpty': 'No tabs in this group yet.',
  'workspaceTabs.groupColorLabel': 'Group colour',
  'workspaceTabs.groupColorSky': 'Sky',
  'workspaceTabs.groupColorGrape': 'Grape',
  'workspaceTabs.groupColorCitrus': 'Citrus',
  'workspaceTabs.groupColorMoss': 'Moss',
  'workspaceTabs.groupColorClay': 'Clay',
  'workspaceTabs.groupColorSlate': 'Slate',
  'workspaceTabs.groupEditAppearance': 'Edit group appearance…',
  'workspaceTabs.groupAppearanceTitle': 'Appearance — {name}',
  'workspaceTabs.groupAppearanceClose': 'Close the appearance editor',
  'workspaceTabs.groupAppearanceAccent': 'Accent',
  'workspaceTabs.groupAppearanceLabelColor': 'Label colour',
  'workspaceTabs.groupAppearanceBackground': 'Header background',
  'workspaceTabs.groupAppearanceWeight': 'Label weight',
  'workspaceTabs.groupAppearanceSize': 'Label size',
  'workspaceTabs.groupAppearanceRadius': 'Corner radius',
  'workspaceTabs.groupAppearanceBadge': 'Badge',
  'workspaceTabs.groupAppearanceBadgeHint': 'An emoji, or a letter or two',
  'workspaceTabs.groupAppearanceReset': 'Reset',
  'workspaceTabs.groupAppearanceResetAll': 'Reset this group to the theme',
  'workspaceTabs.groupAppearanceDefault': 'Theme default',
  'workspaceTabs.groupAppearanceNote':
    'Decoration never replaces the group name or whether it is expanded.',
  'workspaceTabs.searchStripHeading': 'Tabs in this strip',
  'workspaceTabs.searchStripField': 'this tab strip',
  'workspaceTabs.searchGroupsHeading': 'Tab groups',
  'workspaceTabs.searchGroupsField': 'tab groups by name',
  'workspaceTabs.searchInGroupField': 'tabs in {name}',
  'workspaceTabs.searchMasterHeading': 'Every open tab',
  'workspaceTabs.searchMasterField': 'every open tab',
  'workspaceTabs.searchNoTabs': 'No tabs match.',
  'workspaceTabs.searchNoGroups': 'No groups match.',
  'workspaceTabs.masterScope': '{tabs} tabs across {windows} windows',
  'workspaceTabs.resultPinned': 'Pinned',
  'workspaceTabs.resultUngrouped': 'Ungrouped',
  'workspaceTabs.resultCollapsedGroup': 'In a collapsed group',
  'workspaceTabs.resultThisWindow': 'This window',
  'workspaceTabs.resultOtherWindow': 'Window {index}',
  'workspaceTabs.resultStrip': 'Workspace strip',
  'workspaceTabs.otherWindowHint': 'This tab is open in another window.',
  'workspaceTabs.reveal': 'Reveal',
  'workspaceTabs.revealHint': 'Shows the tab without expanding its group.',

  // Non-blocking notifications: the corner stack and the notification centre.
  'notifications.title': 'Notifications',
  'notifications.open': 'Open notifications',
  'notifications.unread': '{count} unread',
  'notifications.searchLabel': 'Search notifications',
  'notifications.searchPlaceholder': 'Search notifications…',
  'notifications.markAllRead': 'Mark all read',
  'notifications.markRead': 'Mark as read',
  'notifications.clear': 'Clear all',
  'notifications.dismiss': 'Dismiss',
  'notifications.empty': 'Nothing yet. Anything the app tells you is kept here.',
  'notifications.noMatches': 'No notification matches that search.',
  'notifications.actionOffered': 'This offered: {label}',
  'notifications.stackOverflow': '{count} more waiting in the notification centre',
  'notifications.severityInfo': 'Info',
  'notifications.severitySuccess': 'Done',
  'notifications.severityProgress': 'Working',
  'notifications.severityWarning': 'Warning',
  'notifications.severityError': 'Error',

  // Destructive-action super confirmation: two keys, then the slider.
  'destructive.affects': 'What this affects',
  'destructive.irreversible': 'This cannot be undone. Everything listed above is destroyed for good.',
  'destructive.reversible': 'This can be undone afterwards from version history.',
  'destructive.keysLabel': 'Authorisation keys',
  'destructive.keyFirst': 'First key — I have read what this affects',
  'destructive.keyFirstHint': 'Turn this on to confirm you have read every item listed above.',
  'destructive.keySecond': 'Second key — I accept the consequences',
  'destructive.keySecondHint': 'Turn this on to accept the outcome stated above. Both keys must be on before the slider will move.',
  'destructive.sliderLabel': 'Slide all the way across to authorise: {action}',
  'destructive.sliderValue': '{percent}% authorised',
  'destructive.statusLocked': 'Locked. Turn both keys on to unlock the slider.',
  'destructive.statusArmed': 'Unlocked — {percent}% of the way. Keep sliding to the far end.',
  'destructive.statusReady': 'Slider at the end. Authorised.',
  'destructive.statusRunning': 'Running now: {action}',
  'destructive.statusDone': 'Done. {action} finished.',
  'destructive.statusFailed': '{action} failed. Nothing more was done; both keys and the slider have been reset.',
  'destructive.emergencyExit': 'Emergency exit',
  'destructive.emergencyExitHint': 'Closes immediately and destroys nothing. Escape does the same.',
  'destructive.emergencyExitRunning': '{action} has already started — closing this will not stop it.',

  // Bulk actions: the selection bar, the preview, the progress and the outcome.
  'bulk.barLabel': 'Bulk actions',
  'bulk.selected': '{n} selected',
  'bulk.selectedOnPage': '{n} selected on this page',
  'bulk.selectedEveryMatch': '{n} selected — every match',
  'bulk.selectPage': 'Select this page ({n})',
  'bulk.selectEveryMatch': 'Select every match ({n})',
  'bulk.invert': 'Invert selection',
  'bulk.clear': 'Clear selection',
  'bulk.previewCounts': '{selected} selected · {willChange} will change',
  'bulk.previewWillChange': 'Will change ({n})',
  'bulk.previewMore': 'and {n} more',
  'bulk.previewNothing': 'Nothing here will change.',
  'bulk.previewSkipped': 'Skipped ({n})',
  'bulk.previewMissing': 'No longer in the list ({n})',
  'bulk.previewMissingNote': 'These were selected but have since left the list, so nothing will be done to them.',
  'bulk.progress': '{done} of {total} done',
  'bulk.progressFailed': '{done} of {total} done · {failed} failed',
  'bulk.progressCurrent': 'Working on {label}',
  'bulk.stop': 'Stop',
  'bulk.resultDone': '{n} done.',
  'bulk.resultNothing': 'Nothing was changed.',
  'bulk.resultPartial': '{done} done, {failed} failed.',
  'bulk.resultFailed': 'All {n} failed.',
  'bulk.resultCancelled': 'Stopped after {done} of {total}. {remaining} were not attempted.',
  'bulk.resultSkipped': '{n} skipped.',

  // Design files, in bulk.
  'designFiles.bulkOpen': 'Open {n}',
  'designFiles.bulkOpenTitle': 'Open {n} files',
  'designFiles.bulkDeleteTitle': 'Delete {n} files',
  'designFiles.bulkDownloadTitle': 'Download {n} files',
  'designFiles.bulkCopyPaths': 'Copy {n} paths',
  'designFiles.bulkCopyPathsTitle': 'Copy {n} file paths',
  'designFiles.bulkSkipBusy': 'An agent is still writing to this file',
  'designFiles.bulkSkipNoLocalPath': 'This file has no path on disk',
  'designFiles.bulkSkipOverTabLimit': 'Over the limit of {n} tabs opened at once',

  // What the destructive gate lists for a project or a live artifact.
  'designs.deleteGateProjectItem': 'The project “{name}”, and every file, chat and artifact inside it',
  'designs.deleteGateProjectDetail': 'The project folder is deleted from disk along with its history. This cannot be undone.',
  'designs.deleteGateArtifactItem': 'The live artifact “{title}”',

  // The same, for “delete my data” on the privacy screen.
  ...
  'appearance.color.fieldHint': 'Drag inside the field, or use the arrow keys. Hold Shift for bigger steps.',
  'appearance.color.hue': 'Hue',
  'appearance.color.saturation': 'Saturation',
  'appearance.color.brightness': 'Brightness',
  'appearance.color.alpha': 'Alpha',
  'appearance.color.alphaDropped': 'This colour is stored without transparency, so the alpha will be dropped when you save.',
  'appearance.color.entryLabel': 'Value',
  'appearance.color.entryInvalid': 'That is not a colour value yet. Your text is kept exactly as typed.',
  'appearance.color.clipped': 'Out of range and clipped: {components}',
  'appearance.color.swatches': 'Swatches',
  'appearance.color.recents': 'Recent',
  'appearance.color.spaceSrgb': 'sRGB',
  'appearance.color.noName': 'No exact name',
  'appearance.color.contrast': 'Contrast {ratio} · {rating}',
  ...
  'appearance.color.translations': 'Colour translations',
  ...
  'appearance.color.lossUnmanaged': 'not colour-managed',

  // Names of the built-in appearance presets.
  'appearance.preset.sunset': 'Sunset',
  'appearance.preset.violet': 'Violet',
  'appearance.preset.teal': 'Teal',
  ...
  'appearance.seedLabel': 'Seed colour',
  'appearance.seedHint': 'The whole palette is generated from this one colour, in light and dark alike.',
  'appearance.sizing': 'Sizing',
  'appearance.sizingHint': 'UI scale, density and auto-fit take effect straight away and are remembered.',
  'appearance.uiScaleLabel': 'UI scale',
  'appearance.densityLabel': 'Density',
  'appearance.autoFit': 'Auto-fit to window',
  'appearance.autoFitHint': 'Take the scale from the window width. The slider keeps showing the current scale but stops accepting input while this is on.',
  'appearance.typography': 'Typography',
  'appearance.typographyHint': 'No typeface ships with the app, so each of these is a request: every one ends in a fallback that keeps Chinese, Japanese and Korean text legible.',
  'appearance.fontFamily': 'Font family',
  'appearance.font.default': 'Design default',
  'appearance.font.system': 'System',
  'appearance.font.grotesque': 'Grotesque',
  'appearance.font.humanist': 'Humanist',
  'appearance.font.serif': 'Serif',
  'appearance.font.mono': 'Monospace',
  'appearance.fontInstalled': 'Installed here',
  'appearance.fontNotInstalled': 'Not installed, so the next face in the stack is used',
  'appearance.fontUnknown': 'Cannot tell',
  'appearance.fontSize': 'Text size',
  'appearance.fontWeight': 'Weight',
  'appearance.lineHeight': 'Line height',
  'appearance.letterSpacing': 'Letter spacing',
  'appearance.opticalSize': 'Optical size',
  'appearance.grade': 'Grade',
  'appearance.smallCaps': 'Small caps',
  'appearance.glow': 'Text glow',
  'appearance.unsupportedBadge': 'Saved, not shown',
  'appearance.unsupportedNoVariableFont': 'No bundled typeface declares this axis, so your value is kept and exported but nothing changes on screen.',
  'appearance.unsupportedCjkUnsafe': 'This renders badly for Chinese, Japanese and Korean text, so your value is kept but not applied.',
  'appearance.unsupportedContrastUnsafe': 'Refused on purpose: a shadow behind interface text fails the contrast rules the rest of the app is held to. Your value is kept.',
  'appearance.reset': 'Reset appearance',

  // The optional spoken narrator.
  'narrator.title': 'Spoken narrator',
  'narrator.hint': 'Reads app events out loud, one line at a time. Off until you turn it on.',
  'narrator.enable': 'Turn the narrator on',
  'narrator.enableHint': 'Nothing is spoken while this is off.',
  'narrator.language': 'Spoken language',
  'narrator.languageEnglish': 'English',
  'narrator.languageCantonese': 'Cantonese',
  'narrator.languageBoth': 'Both',
  'narrator.languageBothHint': 'Both speaks the English line first, then the Cantonese one — never at the same time.',
  'narrator.quiet': 'Quiet',
  'narrator.quietHint': 'Nothing is spoken at all while this is on, errors included.',
  'narrator.screenReader': 'A screen reader is running',
  'narrator.screenReaderHint': 'The app cannot detect one. With this on the narrator stays out of the way — only errors and a sample you asked for are still spoken, and more quietly.',
  'narrator.noSpeechEngine': 'This browser has no speech engine, so nothing can be spoken here.',
  'narrator.noCantoneseVoice': 'No Cantonese voice was found on this device. Cantonese lines will be read by whichever voice the platform picks.',
  'narrator.cantoneseVoice': 'Cantonese voice: {voice}',
  'narrator.speakSample': 'Speak a sample',
  'narrator.stop': 'Stop speaking',
  'narrator.sample': 'The narrator is on. This is what it sounds like.',
  'designFiles.renameFailed': 'Rename failed',
  'memory.clearGateItem': 'Every memory extracted from your chats so far — {count} in the list right now',
  'memory.clearGateDetail': 'The extraction history is deleted from disk. Memories you saved yourself are untouched, but nothing in the app brings the extracted list back.',
  'brandDetail.deleteGateItem': 'The brand “{name}” and the design system extracted from it — its palette, type scale and tokens',
  'conv.deleteGateItem': 'The conversation “{title}” and every message in it',
  'automations.deleteGateItem': 'The automation “{name}” and its schedule',
  'automations.deleteGateDetail': 'The automation stops running and is removed from this device. Past runs and the projects they produced are kept; the automation itself is not.',
  'dsManager.deleteGateItem': 'The design system “{title}” — its palette, type scale and tokens',
  'dsManager.deleteGateDetail': 'The design system is removed from this device. Designs already built with it keep their files, but the system itself is gone and nothing in the app restores it.',
  'workspace.deleteFileGateItem': 'The file “{name}” in the project folder',
  'ds.deleteProjectGateItem': 'The design system “{title}”, its project folder, and every file, chat and artifact inside it',
  'ds.deleteProjectGateDetail': 'The project folder is deleted from disk along with the registered design system. Nothing in the app puts it back.',
  ...
  'history.subtitle': 'Every record and setting this app owns, snapshotted into a local Git repository kept beside its own data.',
  'history.openButton': 'Open version history',
  'history.settingsHint': 'Browse, filter, restore and prune the local snapshots of your records and settings.',
  'history.searchLabel': 'Search history',
  'history.searchPlaceholder': 'Search what changed…',
  'history.refresh': 'Reload history',
  'history.unavailable': 'Version history is unavailable: {reason}',
  'history.loadFailed': 'Could not read history: {error}',
  'history.empty': 'Nothing recorded yet',
  'history.emptyHint': 'A revision is written the first time a record or a setting changes. An unchanged state records nothing, so this list stays a list of real events.',
  'history.noMatch': 'No revision matches these filters',
  'history.scopeAll': '{matched} revisions',
  'history.scopeFiltered': '{matched} of {total} revisions',
  'history.loadedOf': '{loaded} of {total} loaded, and the counts cover those',
  'history.loadMore': 'Load {count} more',
  'history.filters': 'Filters',
  'history.filtersHiding': 'Filters are hiding {count} revisions',
  'history.actionsLabel': 'Action',
  'history.domainsLabel': 'Records',
  'history.actionInitial': 'First snapshot',
  'history.actionCreated': 'Created',
  'history.actionUpdated': 'Updated',
  'history.actionDeleted': 'Deleted',
  'history.actionRestored': 'Restored',
  'history.actionUndone': 'Undone',
  'history.actionPruned': 'Pruned',
  'history.actionSettings': 'Settings changed',
  'history.actionRecorded': 'Recorded',
  'history.kindMutation': 'Change',
  'history.changeCount': '{count} changes',
  'history.restoredFrom': 'Restored from {id}',
  'history.changesTitle': 'Changes',
  'history.detailTitle': 'Revision',
  'history.viewEntry': 'View stored bytes',
  'history.hideEntry': 'Hide stored bytes',
  'history.entryRedacted': 'This record sits beside credentials, so its stored bytes are never sent back over HTTP. The size and digest above still identify it exactly.',
  'history.sensitive': 'Sits beside credentials',
  'history.restore': 'Restore this revision',
  'history.restoreLabel': 'Label for the new revision',
  'history.restoreLabelPlaceholder': 'Optional — say why you restored it',
  'history.restoreDone': 'Restored. {count} changes were written back and recorded as a new revision.',
  'history.restoreUnchanged': 'Nothing changed, so nothing was recorded. The live state already matched this revision.',
  'history.restoreFailed': 'Restore failed: {error}',
  'history.appendOnly': 'History is append-only. Restoring writes these bytes back and records a new revision on top, so the state you are replacing stays here and can be restored in turn.',
  'history.retentionTitle': 'Retention',
  'history.retentionRevisions': 'Keep at most this many revisions',
  'history.retentionDays': 'Drop revisions older than this many days',
  'history.retentionUnlimited': 'No limit',
  'history.retentionSaved': 'Retention saved',
  'history.pruneTitle': 'Prune',
  'history.prunePreview': 'Preview what would go',
  'history.pruneNothing': 'Nothing is outside the retention window',
  'history.pruneWould': '{count} revisions would be removed and {kept} kept',
  'history.pruneApply': 'Remove them',
  'history.pruneDone': 'Pruned {count} revisions',
  'history.exportMarkdown': 'Export Markdown',
  'history.exportText': 'Export text',
  'history.exportJson': 'Export JSON',
  'history.exported': 'Saved {filename}',
  ...
  'library.noMatches': 'No matching Library items.',
  'library.loadError': 'Library could not be refreshed. Your loaded items are still available.',
  'library.retry': 'Retry',
  'library.resultsCount': '{count} Library results',
  'library.scopeVisible': 'Selection is limited to the {count} visible matching items.',
  'library.previousAsset': 'Previous asset',
  'library.nextAsset': 'Next asset',
  'library.downloadFigma': 'Download Figma JSON',
  'library.uploadStatus': 'Uploading…',
  'library.uploadDeduped': 'Already in Library',
  'library.uploadDone': 'Added',
  'library.uploadFailed': 'Upload failed',
  'library.uploadTooLarge': 'File is too large. The limit is {count} MB.',
  'library.uploadUnsupported': 'This file format is not supported by the Library.',
  'library.uploadNetworkError': 'Upload could not reach the Library. Try again.',
  'library.uploadNothing': 'Nothing uploaded yet',
  'library.uploadSummary': '{added} added · {failed} failed',
  'library.uploadProgress': 'Uploading · {progress}%',
  'library.cancelUpload': 'Cancel uploads',
  'library.cancellingUpload': 'Cancelling uploads…',
  'library.uploadCancelled': 'Cancelled',
  ...
  'library.loadElementError': 'Could not load element HTML.',
  'library.showHtml': 'Show HTML',
  'library.hideHtml': 'Hide HTML',
  'library.copy': 'Copy',
  'library.copied': 'Copied',
  'library.deleteAction': 'Delete {count} Library asset(s)',
  'library.deleteTarget': '{count} selected Library asset(s)',
  'library.deleteItemOwned': '{title} — the file stored in your Library, plus its caption, OCR text, tags and palette',
  'library.deleteItemReferenced': '{title} — its Library record: caption, OCR text, tags and palette. The file itself stays in the owning project.',
  'library.deleteMore': '…and {count} more assets in the selection',
  'library.deleteDetailMixed': '{owned} stored asset(s) lose their files from disk; {referenced} referenced asset(s) lose only their Library records. Nothing here is kept in local version history, so none of it comes back.',
  'library.deleteDetailOwned': 'The {count} stored asset file(s) are unlinked from the Library folder. Nothing else keeps a second copy, so this cannot be undone.',
  'library.deleteDetailReferenced': 'The owning project keeps the file(s); this removes {count} Library record(s). A later sync can index them again, but captions, OCR text, tags, and palettes are derived again rather than restored.',
  'library.handoffPrompt': 'Use the {count} reference(s) I just added from my Library to refine this design system — pull the palette, typography, and component patterns that fit and update the design tokens.',
