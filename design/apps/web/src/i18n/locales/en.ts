...
export const en: Dict = {
  ...
  'settings.toyLock.description': 'A local, playful interaction speed bump. It is not protection for sensitive data.',
  ...
  'settings.toyLock.policy.pinPassword': 'PIN plus password',
  'settings.toyLock.policy.passwordTotp': 'Password plus authenticator code',
  'settings.toyLock.policy.pinTotp': 'PIN plus authenticator code',
  'settings.toyLock.policy.passwordPinTotp': 'Password plus PIN plus authenticator code',
  ...
  'settings.toyLock.duration.untilClose': 'Until the app closes',
  'settings.toyLock.pinEntryLegend': 'PIN entry',
  ...
  'settings.toyLock.totpHint': 'Enter the secret from your authenticator. The QR code is rendered locally and is never sent or saved.',
  ...
  'settings.toyLock.recovery': "Recovery: deleting this app's local application-data folder clears toy locks. It also clears other locally stored application state.",
  ...
  'settings.toyLock.noticeRequiredTotp': 'Enter the Base32 secret from your authenticator before beginning pairing.',
  'settings.toyLock.noticePairingReady': 'Pairing is ready. Enter the current six-digit authenticator code to confirm this lock.',
  'settings.toyLock.noticeSaved': 'Toy lock saved. This is a self-imposed interaction lock, not security or encryption.',
  'settings.toyLock.noticeSavedAfterPairing': 'Toy lock saved after authenticator confirmation.',
  'settings.toyLock.noticeRemoved': 'Toy lock removed.',
  'settings.toyLock.noticeHostTimeout': 'The protected host did not answer before the deadline. No change was applied.',
  'settings.toyLock.statusLoading': 'Toy-lock state is loading. Settings content is temporarily unavailable until it settles.',
  'settings.toyLock.statusUnavailable': 'Toy-lock state is unavailable. Settings content is blocked until the protected host responds.',
  'settings.toyLock.failureOsProtection': 'This computer cannot provide the protected credential store required for toy locks.',
  'settings.toyLock.failureStaleRevision': 'The lock changed elsewhere. The latest lock details were loaded; review them and try again.',
  'settings.toyLock.failureEnrollmentMismatch': 'That authenticator code did not confirm the pairing. The existing lock was left unchanged.',
  'settings.toyLock.failureEnrollmentExpired': 'The pairing transaction expired. Start the pairing again.',
  'settings.toyLock.failureGeneric': 'The lock could not be changed. No credential value was saved.',
  'settings.toyLock.authTitle': 'Authentication required',
  'settings.toyLock.authSubtitle': 'Unlock {target} before its action can run.',
  ...
  'settings.toyLock.authExhausted': 'No attempts remain. Cancel and reopen this prompt to try again.',
  ...
  'settings.toyLock.authInvalidPin': 'Enter a PIN containing 4 to 12 digits.',
  'settings.toyLock.authRequired': 'Enter this factor before continuing.',
  'settings.toyLock.authRejected': 'That factor did not match.',
  'settings.toyLock.authVerificationFailed': 'The factor could not be checked. Try again.',
  ...
  'settings.toyLock.dropdownOpen': 'Open choices',
  'settings.toyLock.choiceStatus': '{count} choices, {label} active',
  'settings.toyLock.qrLabel': 'Authenticator pairing QR code',
  'settings.toyLock.qrReveal': 'Reveal manual pairing secret',
  'settings.toyLock.qrHide': 'Hide manual pairing secret',
  'settings.toyLock.qrManual': 'Manual pairing secret',
  'settings.toyLock.qrUnavailable': 'Enter a valid uppercase Base32 secret to render the local QR code.',
  'settings.toyLock.qrParameters': 'Local pairing uses otpauth, SHA1, 6 digits, and a 30-second period.',
  'settings.toyLock.supportOpen': 'Forgotten your password? Open Support Tickets',
  'settings.toyLock.supportTitle': 'Support Tickets',
  'settings.toyLock.supportDisclosure': 'Nothing is sent anywhere. No ticket exists outside this computer, no network request is made, no data is collected, and nobody is reading it.',
  ...
  'settings.toyLock.supportCategoryOther': 'Other local inconvenience',
  ...
  'settings.toyLock.supportStatus': 'Ticket {id}, severity dramatic, status {status}.',
  'settings.toyLock.supportOpenFolder': 'Open application-data folder',
  'settings.toyLock.supportFolderOpened': 'The application-data folder was opened. Delete it yourself to reset the toy locks.',
  ...
  'settings.toyLock.supportPathCopyUnavailable': 'Clipboard access is unavailable. Select and copy the displayed recovery path manually.',
  'settings.toyLock.supportFolderFailed': 'The application-data folder could not be opened. Nothing was deleted.',
  'settings.toyLock.supportResolution': 'Resolution: open the folder and delete it yourself if you need to reset the local toy locks.',
  'settings.toyLock.supportReviewDismiss': '{count} selected ticket(s) will be dismissed. Review this count before continuing.',
  'settings.toyLock.supportReviewExport': '{count} selected ticket(s) will be exported from the filtered view. Review this count before continuing.',
  'settings.toyLock.supportReviewConfirm': 'Confirm action',
  'settings.toyLock.supportReviewCancel': 'Cancel action',
  'settings.toyLock.supportFirstResponse': 'First response: the local desk read the manual once and points to the recovery folder.',
  'settings.toyLock.supportMigration': '{count} older local ticket(s) were migrated with severity dramatic and kept on this computer.',
  'settings.toyLock.supportCollisionExhausted': 'A unique local ticket number could not be allocated after five attempts. No ticket was created.',
  ...
  'settings.toyLock.tabAppearanceHint': 'Changes apply live to this Settings tab and stay local to this computer.',
  'settings.toyLock.tabAppearanceSearch': 'Search appearance properties',
  'settings.toyLock.tabAppearanceColors': 'Text and background colour',
  'settings.toyLock.tabAppearanceTextColor': 'Text colour',
  'settings.toyLock.tabAppearanceBackgroundColor': 'Background colour',
  ...
  'settings.toyLock.tabAppearanceShape': 'Shape and radius',
