...
export const en: Dict = {
  ...
  'chat.runError.cliSessionRefusedMessage':
    "{agent} refused to start a session. The installed version is usually incompatible with Material Designer — switch to a different version and retry.",
  ...
  'labs.harnessHint': "Your next generation will use Material Designer's latest strategy, with noticeably more polished results (beta)",
  'labs.harnessTooltip': "Switches to the agent harness Material Designer uses for design work. Output is noticeably better in layout, structure, and completeness.",
