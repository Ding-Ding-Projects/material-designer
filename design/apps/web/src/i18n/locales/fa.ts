...
export const fa: Dict = {
  ...
  'documentation.title': 'مستندات',
  'documentation.offlineDescription': 'همه مقاله‌ها را به‌صورت آفلاین از درخت منبع بسته‌بندی‌شده بخوانید.',
  'documentation.articlesTab': 'مقاله‌ها',
  'documentation.historyTab': 'اخیراً خوانده‌شده',
  'documentation.articleCount': '{count} مقاله بسته‌بندی‌شده به‌صورت آفلاین در دسترس است',
  'documentation.source': 'باز کردن منبع',
  'documentation.suggested': 'مقاله‌های پیشنهادی',
  'documentation.articleSearch': 'جست‌وجوی مقاله‌های مستندات',
  'documentation.historySearch': 'جست‌وجوی سابقه خواندن',
