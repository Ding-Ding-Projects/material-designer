...
export const fa: Dict = {
  ...
  'chat.runError.cliSessionRefusedMessage':
    "{agent} از شروع جلسه خودداری کرد. معمولاً نسخهٔ نصب‌شده با Material Designer سازگار نیست؛ به نسخهٔ دیگری تغییر دهید و دوباره تلاش کنید.",
  ...
  'labs.title': "آزمایشگاه Material Designer",
  ...
  'labs.harnessHint': "با فعال‌سازی، تولید بعدی از جدیدترین استراتژی Material Designer استفاده می‌کند و خروجی محسوساً پرداخته‌تر است (بتا)",
  'labs.harnessTooltip': "به agent harness ای که Material Designer برای کارهای طراحی ساخته سوئیچ می‌کند. چیدمان، ساختار و کامل بودن خروجی به‌طور محسوس بهتر می‌شود.",
  ...
  'documentation.articlesTab': 'مقاله‌ها',
  'documentation.historyTab': 'اخیراً خوانده‌شده',
  'documentation.articleSearch': 'جست‌وجوی مقاله‌ها',
  'documentation.historySearch': 'جست‌وجوی تاریخچهٔ مطالعه',
  'documentation.invalidRegex': 'الگو نامعتبر یا پرخطر است.',
  'documentation.empty': 'هیچ مقالهٔ همراهی با این جست‌وجو مطابقت ندارد.',
  'documentation.source': 'باز کردن مقالهٔ منبع',
  'documentation.suggested': 'مقاله‌های پیشنهادی',
};
