...
const HOME_PROMPT_EXAMPLES: Record<Locale, Record<string, string[]>> = {
  ...
  "zh-HK": {
    prototype: [
      "為 AI CRM 設計一個高轉換率網站，有清晰主視覺、功能故事、用家好評同試用 CTA",
      "為團隊知識庫做個桌面儀表板，有搜尋、最近更新、權限管理同協作入口",
      "重新設計金融 SaaS 產品嘅引導流程，等新用戶可以快啲駁好資料、設定好就體驗到第一個價值",
      "為流動健身教練 app 整個原型，包括目標設定、每週計劃、運動打卡同進度回顧",
    ],
    deck: [
      "研究產品上市嘅市場機會，包括競爭對手、目標客群、定價假設同上市故事",
      "產生每週團隊進度報告，包括進展、風險、指標變化同下星期優先事項",
      "設計一份投資者推介簡報，包括市場規模、增長模型、產品優勢同三年預測數據",
      "製作策略性業務檢討簡報，涵蓋季度表現、根本原因、機會點同後續行動",
    ],
    image: [
      "產生一張玻璃質感 AI 工作空間海報，有多螢幕協作、柔和光線同高質感上市氛圍",
      "為全新無線耳機做張電商主視覺，突出物料細節、使用情境同核心優點",
      "設計簡約科技上市主視覺，構圖乾淨、產品焦點明確，配上克制上市文案",
      "為產品開賣整系列社群預告，包括倒數計時、細節特寫、優點揭示同上市當日視覺",
    ],
    video: [
      "製作一段 8 秒產品揭曉短片，由剪影推進到細節特寫，最後以品牌標誌收結",
      "產生一段 app 功能示範影片，按用戶旅程展示關鍵狀態同最終成果",
      "為短影音製作直向品牌開場，配節奏字體動畫、產品特寫同乾淨 logo 收尾",
      "將網站轉成 15 秒社交廣告，提煉主視覺主張、互動亮點同行動呼籲",
    ],
    hyperframes: [
      "製作一段有字幕嘅產品上市短片，包括標題卡、功能畫面、節奏轉場同結尾 CTA",
      "產生一個聲音反應數據可視化，讓長條圖、粒子同標題隨旁白節奏郁動",
      "用線條匯聚、細緻彈性動態同品牌色彩系統，整一個 3 秒 logo 收尾動畫",
      "製作一張動態航線地圖，展示城市節點、航線延伸、里程數據同最終摘要畫面",
    ],
    audio: [
      "產生一個產品啟動音效，聽落輕盈、可信、帶少少未來感，適合桌面 app 開機播放",
      "製作一段 20 秒 Podcast 開場音樂，溫暖前奏、清晰節拍，適合人聲進入",
      "為冥想 app 製作無縫環境音循環，柔和自然聲、低頻溫暖同穩定節奏",
      "產生一組品牌通知提示音，區分成功、提醒同錯誤狀態，但保持同一聲音識別度",
    ],
  },
  "pt-BR": {
    prototype: [
