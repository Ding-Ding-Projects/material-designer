...
export function useConverterCopy(): (key: ConverterCopyKey, vars?: Variables) => string {
  ...
  return useCallback((key: ConverterCopyKey, vars?: Variables) => {
    const en = tone(interpolate(EN[key], vars), 'en', funnyLevels.en, key);
