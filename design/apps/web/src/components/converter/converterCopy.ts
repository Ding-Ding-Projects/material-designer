...
const EN: Record<ConverterCopyKey, string> = {
  lossyQueueUnavailable: 'Lossy conversions require just-in-time review. Use Convert now instead of the durable queue.',
...
const YUE: Record<ConverterCopyKey, string> = {
  ...EN,
  lossyQueueUnavailable: '有損轉換要即時逐次確認。請用「即刻轉換」，唔好放入長期隊列。',
