...
export const SETTINGS_INDEX: readonly SettingsIndexEntry[] = [
  ...
  },
  {
    ...
    titleKey: 'settings.general',
    hintKey: 'settings.generalHint',
    keywords: ['universal settings', 'school mode', 'scheduled settings', 'attention modes', 'status hub', 'dialog emojis'],
  },
  {
    id: 'universal.showDialogEmoji',
    section: 'general',
    titleKey: 'settings.general',
    hintKey: 'settings.generalHint',
    keywords: ['dialog emoji', 'message box emoji', 'show emojis'],
  },
  {
    id: 'universal.schoolMode',
    section: 'general',
    titleKey: 'settings.general',
    hintKey: 'settings.generalHint',
    keywords: ['school mode', 'shared mode', 'unlock', 'display name'],
  },
  {
    id: 'universal.adhd.nextAction',
    section: 'general',
    titleKey: 'settings.general',
    hintKey: 'settings.generalHint',
    keywords: ['focus', 'low stimulation', 'time awareness', 'one thing at a time', 'momentum', 'next action'],
  },
  {
