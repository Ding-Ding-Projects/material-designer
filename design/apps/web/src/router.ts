...
export type EntryHomeView =
  ...
  | 'handoff'
  /** Local authenticator destination with protected history manager. */
  | 'authenticator'
...
export type Route =
  | {
      kind: 'home';
      view: EntryHomeView;
      /** Optional deep-link subsection for the full-page Settings surface. */
