 ...
 */
const themeInitScript = `(function(){try{var w=window;var u=new URL(location.href);var tuple=w.__MATERIAL_DESIGNER_CAPTURE_TUPLE__;var fixture=u.protocol==='od:'&&u.hostname==='app'&&u.port===''&&u.username===''&&u.password===''&&u.hash===''&&u.pathname==='/projects/fixture-studio-project/conversations/fixture-studio-conversation/files/orders-dashboard.html'&&tuple&&tuple.screen==='studio'&&tuple.state==='default'&&tuple.fixtureRevision==='material-designer-m3-v2'&&tuple.network==='disabled';var c=fixture?{}:JSON.parse(localStorage.getItem('open-design:config')||'{}');var t=fixture?'light':c.theme;if(t==='light'||t==='dark')document.documentElement.setAttribute('data-theme',t);else if(t==='system')document.documentElement.removeAttribute('data-theme');var a=fixture?'var(--md-sys-color-primary)':typeof c.accentColor==='string'&&/^#[0-9a-fA-F]{6}$/.test(c.accentColor.trim())?c.accentColor.trim().toLowerCase():'var(--md-sys-color-primary)';if(!fixture&&c.configMigrationVersion!==3&&(a==='#87ea5c'||a==='#c96442'))a='var(--md-sys-color-primary)';var s=document.documentElement.style;s.setProperty('--accent',a);s.setProperty('--accent-strong','color-mix(in srgb, '+a+' 82%, var(--text-strong))');s.setProperty('--accent-soft','color-mix(in srgb, '+a+' 12%, var(--bg-subtle))');s.setProperty('--accent-tint','color-mix(in srgb, '+a+' 6%, var(--bg-panel))');s.setProperty('--accent-hover','color-mix(in srgb, '+a+' 86%, var(--text-strong))');}catch(e){}})();`;
