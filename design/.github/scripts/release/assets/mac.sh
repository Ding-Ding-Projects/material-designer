...
source_dmg="$tools_pack_dir/out/mac/namespaces/$TOOLS_PACK_NAMESPACE/dmg/Material Designer-$TOOLS_PACK_NAMESPACE.dmg"
source_zip="$tools_pack_dir/out/mac/namespaces/$TOOLS_PACK_NAMESPACE/zip/Material Designer-$TOOLS_PACK_NAMESPACE.zip"
...
release_notes="${RELEASE_NOTES:-Material Designer $RELEASE_VERSION$asset_suffix}"
