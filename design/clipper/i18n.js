...
(function () {
  ...
  const en = {
    ...
    downloadProgressSummary: 'The extension is transferring the captured file.', downloadProgressTitle: 'Downloading',
    downloadProgressMessage: '{filename} is downloading.', downloadProgressDetail: '{received} of {total} bytes received.',
    ...
    downloadFailedTitle: 'Download failed', downloadFailedMessage: 'The download could not finish: {error}',
    downloadInterrupted: 'The browser interrupted the download.', downloadProposalExpired: 'This download proposal expired. Start the capture again.',
    downloadStartOpened: 'Start download opened for review.', downloadSourceLabel: 'Source', downloadDestinationLabel: 'Destination',
    downloadSource: 'Active browser tab', downloadDestination: 'Browser Downloads folder', downloadRate: '{rate} bytes/s',
    downloadEta: '{seconds}s remaining', downloadPause: 'Pause', downloadResume: 'Resume', downloadCancel: 'Cancel download',
  ...
  const overrides = {
    ...
    'zh-CN': {
      ...
      downloadWindowTitle: '下载 Figma JSON', downloadWindowEyebrow: '扩展下载', downloadStartTitle: '开始下载',
      downloadStartSummary: '文件进入下载队列前，请先检查这份捕获文件。', downloadDetailsLabel: '下载详情', downloadStartAction: '开始下载',
      downloadFileSize: '{bytes} 字节', downloadProgressLabel: '正在下载', downloadProgressSummary: '扩展正在传输捕获文件。',
      downloadProgressTitle: '正在下载', downloadProgressMessage: '{filename} 正在下载。', downloadProgressDetail: '已接收 {received} / {total} 字节。',
      downloadCompleteTitle: '下载完成', downloadCompleteMessage: '{filename} 已准备好。', downloadCompleteDetail: '{filename} 已下载完成，现在可以导入 Figma 插件。',
      downloadFailedTitle: '下载失败', downloadFailedMessage: '下载未能完成：{error}', downloadInterrupted: '浏览器中断了下载。',
      downloadProposalExpired: '下载提案已过期，请重新捕获。', downloadStartOpened: '下载已打开，请先检查。', downloadSourceLabel: '来源', downloadDestinationLabel: '目标位置',
      downloadSource: '当前浏览器标签页', downloadDestination: '浏览器下载文件夹', downloadRate: '{rate} 字节/秒', downloadEta: '剩余 {seconds} 秒',
      downloadPause: '暂停', downloadResume: '继续', downloadCancel: '取消下载',
