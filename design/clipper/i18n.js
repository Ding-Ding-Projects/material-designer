// OpenDesign Web Clipper i18n runtime.
//
...
(function () {
  ...
  const en = {
    extensionName: 'OpenDesign Web Clipper',
    extensionDescription: 'Clip pages, design systems, screenshots, images, and Figma import JSON into your OpenDesign Library.',
    ...
    hintHtml: '<strong>OpenDesign</strong> is not running. Start the app, then reopen this popup - the clipper connects automatically.',
    advanced: 'Advanced',
    ...
    refreshPageTitle: 'Reload this page so OpenDesign can attach',
    ...
    openDesignNotRunning: 'OpenDesign is not running - start the app first.',
    savedConnected: 'Saved - connected.',
    savedNotDetected: 'Saved, but OpenDesign was not detected at that URL.',
    ...
    downloadWindowTitle: 'Download Figma JSON', downloadWindowEyebrow: 'Extension download', downloadStartTitle: 'Start download',
    downloadStartSummary: 'Review this captured file before it enters the download queue.', downloadDetailsLabel: 'Download details',
    downloadStartAction: 'Start download', downloadFileSize: '{bytes} bytes', downloadProgressLabel: 'Downloading',
    downloadProgressSummary: 'The extension is transferring the captured file.', downloadPausedSummary: 'The transfer is paused.',
    downloadProgressTitle: 'Downloading', downloadProgressMessage: '{filename} is downloading.',
    downloadProgressDetail: '{received} of {total} received.', downloadProgressDetailUnknown: '{received} received; total size is not available yet.',
    downloadCompleteTitle: 'Download complete', downloadCompleteMessage: '{filename} is ready.',
    downloadCompleteDetail: '{filename} finished downloading. You can now import it into the Figma plugin.',
    downloadCancelledDetail: '{filename} was cancelled before completion.', downloadFailedTitle: 'Download failed',
    downloadFailedMessage: 'The download could not finish: {error}', downloadInterrupted: 'The browser interrupted the download.',
    downloadProposalExpired: 'This download proposal expired. Start the capture again.', downloadStartOpened: 'Start download opened for review.',
    downloadAlreadyHandled: 'This download proposal is already being handled.', downloadActionPending: 'Another download action is still pending.',
    downloadPauseUnavailable: 'Pause is not available for this transfer.', downloadResumeUnavailable: 'Resume is not available for this transfer.',
    downloadCancelUnavailable: 'Cancel is not available for this transfer.', downloadRetryUnavailable: 'Retry is not available for this transfer.',
    downloadOpenUnavailable: 'Open is not available until the transfer is complete.', downloadOpenFailed: 'The downloaded file could not be opened.',
    downloadRetry: 'Retry', downloadOpen: 'Open file', downloadReceivedLabel: 'Received', downloadExtensionOriginLabel: 'Extension',
    downloadBytesUnit: 'bytes', downloadRateUnit: 'bytes/s', downloadSizeUnknown: 'size unknown',
    downloadRateUnknown: 'Transfer rate is not available yet.', downloadEtaUnknown: 'ETA is not available yet.',
    downloadPercentUnknown: 'size unknown', downloadAlwaysOnTop: 'Always-on-top state: {state}.', downloadAlwaysOnTopUnknown: 'Always-on-top state has not been confirmed.',
    ...
    odNotAttached: 'OpenDesign has not attached to this page yet.',
    ...
    toolbarDragLabel: 'Drag the OpenDesign bar',
    toolbarHomeTip: 'OpenDesign - open-design.ai',
    toolbarHomeLabel: 'OpenDesign home',
    ...
    toolbarHide: 'Hide OpenDesign bar',
    openDesignStartApp: 'OpenDesign is not running - start the app',
    ...
    saveImageToLibrary: 'Save image to OpenDesign Library',
    saveImageToOpenDesign: 'Save image to OpenDesign',
  ...
  const overrides = {
    id: {
      extensionDescription: 'Klip halaman, sistem desain, tangkapan layar, gambar, dan JSON impor Figma ke Library OpenDesign.',
    ...
    de: {
      extensionDescription: 'Sammle Seiten, Designsysteme, Screenshots, Bilder und Figma-Import-JSON in deiner OpenDesign Library.',
    ...
    'zh-CN': {
      extensionName: 'OpenDesign 网页剪藏',
      extensionDescription: '将网页、设计系统、截图、图片和 Figma 导入 JSON 剪藏到 OpenDesign 素材库。',
      ...
      hintHtml: '<strong>OpenDesign</strong> 未运行。启动应用后重新打开此弹窗，插件会自动连接。',
      ...
      daemonUrl: 'Daemon 地址', save: '保存', refreshPage: '刷新页面', refreshPageTitle: '刷新此页面以便 OpenDesign 挂载',
      toggleOnPageBar: '切换页面浮条', toggleImageHover: '切换图片悬浮捕获按钮',
      openDesignNotRunning: 'OpenDesign 未运行，请先启动应用。', savedConnected: '已保存，已连接。',
      savedNotDetected: '已保存，但该地址未检测到 OpenDesign。', capturingPage: '正在捕获页面...',
      ...
      odNotAttached: 'OpenDesign 尚未挂载到此页面。', elementPickerUnavailable: '此页面不可使用元素选择器，请尝试普通网站。',
      ...
      toolbarDrag: '拖动移动', toolbarDragLabel: '拖动 OpenDesign 浮条', toolbarCapturePage: '捕获页面 -> 素材库',
      ...
      toolbarHide: '隐藏 OpenDesign 浮条', openDesignStartApp: 'OpenDesign 未运行，请启动应用',
      ...
      saveImageToLibrary: '保存图片到 OpenDesign 素材库', saveImageToOpenDesign: '保存图片到 OpenDesign',
    ...
    'zh-TW': {
      extensionName: 'OpenDesign 網頁剪藏',
      extensionDescription: '將網頁、設計系統、截圖、圖片和 Figma 匯入 JSON 剪藏到 OpenDesign 素材庫。',
    ...
    'pt-BR': {
      extensionDescription: 'Capture páginas, kits de marca, screenshots, imagens e JSON de importação do Figma na sua Library OpenDesign.',
    ...
    'es-ES': {
      extensionDescription: 'Guarda páginas, kits de marca, capturas, imágenes y JSON de importación de Figma en tu Library de OpenDesign.',
    ...
    ru: {
      extensionDescription: 'Сохраняйте страницы, дизайн-системы, скриншоты, изображения и Figma import JSON в библиотеку OpenDesign.',
    ...
    fa: {
      extensionDescription: 'صفحه‌ها، سیستم‌های طراحی، اسکرین‌شات‌ها، تصاویر و JSON واردسازی Figma را در کتابخانه OpenDesign ذخیره کنید.',
    ...
    ar: {
      extensionDescription: 'احفظ الصفحات وأنظمة التصميم ولقطات الشاشة والصور وملف Figma JSON في مكتبة OpenDesign.',
    ...
    ja: {
      extensionDescription: 'ページ、デザインシステム、スクリーンショット、画像、Figma インポート JSON を OpenDesign Library に保存します。',
    ...
    ko: {
      extensionDescription: '페이지, 디자인 시스템, 스크린샷, 이미지, Figma 가져오기 JSON을 OpenDesign Library에 저장합니다.',
    ...
    pl: {
      extensionDescription: 'Zapisuj strony, systemy projektowe, zrzuty ekranu, obrazy i JSON importu Figma w bibliotece OpenDesign.',
    ...
    hu: {
      extensionDescription: 'Oldalak, designrendszerek, képernyőképek, képek és Figma import JSON mentése az OpenDesign Librarybe.',
    ...
    fr: {
      extensionDescription: 'Capturez pages, systèmes de design, captures, images et JSON import Figma dans votre Library OpenDesign.',
    ...
    uk: {
      extensionDescription: 'Зберігайте сторінки, дизайн-системи, скриншоти, зображення та Figma import JSON у бібліотеку OpenDesign.',
    ...
    tr: {
      extensionDescription: 'Sayfaları, tasarım sistemlerini, ekran görüntülerini, görselleri ve Figma içe aktarma JSONunu OpenDesign Libraryye kaydedin.',
    ...
    th: {
      extensionDescription: 'บันทึกหน้าเว็บ ระบบดีไซน์ ภาพหน้าจอ รูปภาพ และ Figma import JSON ไปยัง OpenDesign Library',
    ...
    it: {
      extensionDescription: 'Salva pagine, design system, screenshot, immagini e JSON di importazione Figma nella Library OpenDesign.',
    ...
    vi: {
      extensionDescription: 'Lưu trang, hệ thống thiết kế, ảnh chụp màn hình, hình ảnh và JSON nhập Figma vào OpenDesign Library.',
    ...
    nl: {
      extensionDescription: 'Sla pagina’s, designsystemen, screenshots, afbeeldingen en Figma-import-JSON op in je OpenDesign Library.',
