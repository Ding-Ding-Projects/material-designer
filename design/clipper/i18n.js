...
(function () {
  ...
  const en = {
    ...
    downloadSourceLabel: 'Source', downloadDestinationLabel: 'Destination', downloadSource: 'Active browser tab', downloadDestination: 'Browser Downloads folder', downloadRate: '{rate} bytes/s', downloadEta: '{seconds}s remaining',
    ...
    imageSourceGone: 'That image’s source is no longer on the page',
  ...
  const overrides = {
    ...
    'zh-CN': {
      ...
      downloadFileSize: '{bytes} 字节', downloadProgressLabel: '正在下载', downloadProgressSummary: '扩展正在传输捕获文件。', downloadPausedSummary: '传输已暂停。',
      downloadProgressTitle: '正在下载', downloadProgressMessage: '{filename} 正在下载。', downloadProgressDetail: '已接收 {received} / {total} 字节。',
      downloadProgressDetailUnknown: '已接收 {received} 字节，暂时未知总大小。', downloadCompleteTitle: '下载完成', downloadCompleteMessage: '{filename} 已准备好。',
      downloadCompleteDetail: '{filename} 已下载完成，现在可以导入 Figma 插件。', downloadCancelledDetail: '{filename} 在完成前已取消。',
      downloadFailedTitle: '下载失败', downloadFailedMessage: '下载未能完成：{error}', downloadInterrupted: '浏览器中断了下载。',
      downloadProposalExpired: '下载提案已过期，请重新捕获。', downloadStartOpened: '下载已打开，请先检查。', downloadAlreadyHandled: '下载提案正在处理中。',
      downloadActionPending: '另一个下载操作正在处理中。', downloadPauseUnavailable: '此传输无法暂停。', downloadResumeUnavailable: '此传输无法继续。',
      downloadCancelUnavailable: '此传输无法取消。', downloadRetryUnavailable: '此传输无法重试。', downloadOpenUnavailable: '传输完成后才能打开。',
      downloadOpenFailed: '无法打开已下载文件。', downloadRetry: '重试', downloadOpen: '打开文件', downloadReceivedLabel: '已接收', downloadExtensionOriginLabel: '扩展',
      downloadBytesUnit: '字节', downloadRateUnit: '字节/秒', downloadSizeUnknown: '大小未知', downloadRateUnknown: '暂时无法提供传输速率。',
      downloadSourceLabel: '来源', downloadDestinationLabel: '目标位置', downloadSource: '当前浏览器标签页', downloadDestination: '浏览器下载文件夹', downloadRate: '{rate} 字节/秒', downloadEta: '剩余 {seconds} 秒',
      downloadEtaUnknown: '暂时无法提供剩余时间。', downloadPercentUnknown: '大小未知', downloadAlwaysOnTop: '置顶状态：{state}。',
      downloadAlwaysOnTopUnknown: '尚未确认置顶状态。',
