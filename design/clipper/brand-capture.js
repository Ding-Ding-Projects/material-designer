...
(function () {
  ...
  // Keep only the four bootstrap labels here. The extension's shared i18n
  // bundle carries every capture label, while this tiny map keeps the renderer
  // readable if that bundle is unavailable during early startup.
  const EN_FALLBACK = {
