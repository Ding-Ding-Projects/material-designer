...
describe("resolveWinInstallIdentity", () => {
  it("keeps the default namespace on the canonical Windows display name", () => {
    expect(resolveWinInstallIdentity({ namespace: "default" })).toMatchObject({
      ...
      shortcutName: "Material Designer.lnk",
      uninstallerName: "Uninstall Material Designer.exe",
    });
  });
  ...
  it("uses the canonical Windows display name for stable release namespaces", () => {
    expect(resolveWinInstallIdentity({ namespace: "release-stable-win" })).toMatchObject({
      appPathsKey: "Software\\Microsoft\\Windows\\CurrentVersion\\App Paths\\Material Designer.exe",
      displayName: "Material Designer",
      registryKey: "Software\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\Material Designer-release-stable-win",
      shortcutName: "Material Designer.lnk",
      uninstallerName: "Uninstall Material Designer.exe",
    });
  });
  ...
  it("uses first-class beta display identity for beta release namespaces", () => {
    expect(resolveWinInstallIdentity({ namespace: "release-beta-win" })).toMatchObject({
      appPathsKey: "Software\\Microsoft\\Windows\\CurrentVersion\\App Paths\\Material Designer Beta.exe",
      displayName: "Material Designer Beta",
      registryKey: "Software\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\Material Designer-release-beta-win",
      shortcutName: "Material Designer Beta.lnk",
      uninstallerName: "Uninstall Material Designer Beta.exe",
    });
  });
  ...
  it("keeps non-release beta-like namespaces isolated from the real beta channel identity", () => {
    expect(resolveWinInstallIdentity({ namespace: "beta-local-flow" })).toMatchObject({
      appPathsKey: "Software\\Microsoft\\Windows\\CurrentVersion\\App Paths\\Material Designer beta-local-flow.exe",
      displayName: "Material Designer beta-local-flow",
      registryKey: "Software\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\Material Designer-beta-local-flow",
      shortcutName: "Material Designer beta-local-flow.lnk",
      uninstallerName: "Uninstall Material Designer beta-local-flow.exe",
    });
  });
  ...
  it("uses first-class preview display identity for preview release namespaces", () => {
    expect(resolveWinInstallIdentity({ namespace: "release-preview-win" })).toMatchObject({
      appPathsKey: "Software\\Microsoft\\Windows\\CurrentVersion\\App Paths\\Material Designer Preview.exe",
      displayName: "Material Designer Preview",
      registryKey: "Software\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\Material Designer-release-preview-win",
      shortcutName: "Material Designer Preview.lnk",
      uninstallerName: "Uninstall Material Designer Preview.exe",
    });
  });
  ...
  it("uses first-class prerelease display identity for prerelease release versions and namespaces", () => {
    expect(resolveWinInstallIdentity({
      ...
      appPathsKey: "Software\\Microsoft\\Windows\\CurrentVersion\\App Paths\\Material Designer Prerelease.exe",
      displayName: "Material Designer Prerelease",
      registryKey: "Software\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\Material Designer-release-stable-win",
      shortcutName: "Material Designer Prerelease.lnk",
      uninstallerName: "Uninstall Material Designer Prerelease.exe",
    });
