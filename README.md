...
> `9a556bcfe` records reviewed Groups A through E. Group A repairs deterministic
> parity route resolution, readiness witnesses, and bounded capture lifecycle.
> Group B aligns shell chrome and overlay geometry. Group C repairs settings and
> routine semantics, localized wrapping, target sizes, and focused fixture
> resolution. Group D migrates reviewed shape and motion consumers onto shared
> Material Design tokens while preserving explicit compatibility values. Group E
> repairs declared-path comparison for upstream-only files and adds its regression.
>
...
> plus their focused tests. These remain open and prevent a complete anatomy
> claim.
...
> **Front-screen provenance source checkpoint:** Commit
> [`01c2263a`](https://github.com/Ding-Ding-Projects/material-designer/commit/01c2263a9ae8d54e9fb675934fea6341a6f734f1)
> places a
> visible running version and provenance-bound updated-at value before navigation
> and authentication. Health and version requests have bounded deadlines; missing,
> malformed, host-clock, version-mismatched, or commit-mismatched data remains
> visibly unavailable. The documentation-page workflow injects the tuple only from
> one published release targeting the deployed commit and verifies each visible
> field and immutable installer link. Hosted packaging, installed interaction, and
