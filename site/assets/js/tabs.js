 ...
 *   worse than saying so: the site has exactly eleven permanent sections, so
...
export const DEFAULT_TABS = Object.freeze([
  ...
  { id: 'converter',   icon: 'converter',  en: 'File converter',     yue: '檔案轉換器' },
...
const ICON_PATHS = {
  ...
  converter:  '<path d="M5 4h14v5H5zM5 15h14v5H5z"/><path d="m9 12 3 3 3-3"/>',
