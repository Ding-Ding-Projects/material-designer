...
const CATALOGUE = {
  ...
  'logo.title': { en: 'App logo', yue: 'App 標誌' },
  'logo.hint': { en: 'Choose a bundled mark or select a local image. The mark changes presentation only, never application identity.', yue: '揀一款內置標誌，或者選擇本機圖片。標誌只改外觀，唔會改應用程式身份。' },
  'logo.reset': { en: 'Reset logo', yue: '重設標誌' },
  'logo.search': { en: 'Search logo presets', yue: '搜尋標誌預設' },
  'logo.presets': { en: 'Logo presets', yue: '標誌預設' },
  'logo.material': { en: 'Material mark', yue: 'Material 標誌' },
  'logo.warm': { en: 'Warm mark', yue: '暖色標誌' },
  ...
  'logo.fill': { en: 'Fill', yue: '拉伸填滿' },
  'logo.focalX': { en: 'Focal point X', yue: '焦點 X' },
  'logo.focalY': { en: 'Focal point Y', yue: '焦點 Y' },
  'logo.safeArea': { en: 'Show safe-area preview', yue: '顯示安全區預覽' },
  'logo.transparent': { en: 'Transparent background', yue: '透明背景' },
  'logo.rainbow': { en: 'Animated rainbow background', yue: '彩虹動畫背景' },
  'logo.rainbowSpeed': { en: 'Rainbow speed level, 1 is fastest and 5 is slowest', yue: '彩虹速度級別，1 最快，5 最慢' },
  'logo.background': { en: 'Logo background colour', yue: '標誌背景顏色' },
  'logo.hue': { en: 'Hue', yue: '色相' },
  'logo.saturation': { en: 'Saturation', yue: '飽和度' },
  'logo.brightness': { en: 'Brightness', yue: '亮度' },
  'logo.alpha': { en: 'Alpha', yue: '透明度' },
  'logo.hex': { en: 'HEX', yue: 'HEX' },
  'logo.cropX': { en: 'X', yue: 'X' },
  'logo.cropY': { en: 'Y', yue: 'Y' },
  'logo.cropWidth': { en: 'Width', yue: '闊度' },
  'logo.cropHeight': { en: 'Height', yue: '高度' },
  'logo.colorTranslations': { en: 'Colour translations', yue: '顏色轉換' },
  'logo.copy': { en: 'Copy', yue: '複製' },
  'logo.colorInvalid': { en: 'Invalid color value. The previous color remains active.', yue: '顏色數值無效，之前嘅顏色繼續生效。' },
  'logo.colorSearch': { en: 'Search colour translations', yue: '搜尋顏色轉換' },
  'logo.colorUnsupported': { en: 'This color space is visible but unsupported by this browser parser. The previous color remains active.', yue: '呢個色彩空間睇得到，但瀏覽器 parser 未支援，之前嘅顏色繼續生效。' },
  'logo.colorClipped': { en: 'Some color components were outside the supported range and were clipped. Review the value before applying it.', yue: '部分顏色元件超出支援範圍並被截斷，套用前請檢查數值。' },
  'logo.upload': { en: 'Choose a local logo image', yue: '選擇本機標誌圖片' },
  'logo.crop': { en: 'Crop, normalized 0–1', yue: '裁切，標準化 0–1' },
  'logo.targets': { en: 'Display-target previews', yue: '顯示目標預覽' },
  'logo.targetFavicon': { en: 'Favicon', yue: 'Favicon' },
  'logo.targetToolbar': { en: 'Toolbar', yue: '工具列' },
  'logo.targetTitlebar': { en: 'Title bar', yue: '標題列' },
  'logo.targetSidebar': { en: 'Sidebar', yue: '側邊欄' },
  'logo.targetInstaller': { en: 'Installer', yue: '安裝程式' },
  'logo.installerPreviewOnly': { en: 'Installer preview only: this mark does not change package identity, installer identity, update feed, or signing state.', yue: '只係安裝程式預覽：標誌唔會改 package identity、安裝程式身份、更新 feed 或簽署狀態。' },
  'logo.sourceAlpha': { en: 'Source includes transparency; generated output alpha is reported separately.', yue: '來源有透明度；生成輸出嘅 alpha 會另外報告。' },
  'logo.sourceOpaque': { en: 'Source is opaque; generated output alpha is reported separately.', yue: '來源不透明；生成輸出嘅 alpha 會另外報告。' },
  'logo.outputAlpha': { en: 'Output alpha present.', yue: '輸出有 alpha。' },
  'logo.outputOpaque': { en: 'Output opaque.', yue: '輸出不透明。' },
  'logo.export': { en: 'Export logo appearance', yue: '匯出標誌外觀' },
  'logo.import': { en: 'Import logo appearance', yue: '匯入標誌外觀' },
  'logo.schedule': { en: 'Scheduled logo appearance', yue: '預約標誌外觀' },
  'logo.scheduleHint': { en: 'Use local date and time. Matching rules apply temporarily and never rewrite the base selection.', yue: '用本機日期同時間。符合嘅規則只係暫時套用，唔會改底層選擇。' },
  'logo.timezone': { en: 'Timezone: {timezone}. Daylight-saving changes follow the platform clock.', yue: '時區：{timezone}。夏令時間轉換跟住平台時鐘。' },
  'logo.scheduleStart': { en: 'Starts', yue: '開始' },
  'logo.scheduleEnd': { en: 'Ends', yue: '結束' },
  'logo.schedulePreset': { en: 'Scheduled preset', yue: '預約預設' },
  'logo.scheduleLabel': { en: 'Schedule label', yue: '預約名稱' },
  'logo.scheduleWeekdays': { en: 'Weekdays', yue: '星期' },
  'logo.scheduleEnabled': { en: 'Enabled', yue: '啟用' },
  'logo.scheduleDelete': { en: 'Delete schedule', yue: '刪除預約' },
  'logo.scheduleEdit': { en: 'Edit schedule', yue: '編輯預約' },
  'logo.sun': { en: 'Sun', yue: '日' },
  'logo.mon': { en: 'Mon', yue: '一' },
  'logo.tue': { en: 'Tue', yue: '二' },
  'logo.wed': { en: 'Wed', yue: '三' },
  'logo.thu': { en: 'Thu', yue: '四' },
  'logo.fri': { en: 'Fri', yue: '五' },
  'logo.sat': { en: 'Sat', yue: '六' },
  'logo.history': { en: 'Logo change history', yue: '標誌變更歷史' },
  'logo.historyEmpty': { en: 'No logo changes recorded locally.', yue: '本機未有標誌變更記錄。' },
  'logo.historyRestore': { en: 'Restore settings', yue: '還原設定' },
  'logo.historyUnavailable': { en: 'The logo changed, but local history could not acknowledge the mutation.', yue: '標誌已經改咗，但本機歷史未能確認今次變更。' },
  'logo.scheduleAdd': { en: 'Add schedule', yue: '加入預約' },
  'logo.scheduleInvalid': { en: 'Enter a valid start and end, with the end after the start.', yue: '請輸入有效開始同結束時間，結束要遲過開始。' },
  'logo.presetApplied': { en: 'Preset applied locally.', yue: '預設已喺本機套用。' },
  'logo.validating': { en: 'Validating and converting locally…', yue: '本機驗證同轉換緊…' },
  'logo.converted': { en: 'Converted locally to a verified {width}×{height} PNG.', yue: '本機已轉換成驗證過嘅 {width}×{height} PNG。' },
  'logo.resetDone': { en: 'Logo selection reset to the shipped mark.', yue: '標誌選擇已重設為出廠標誌。' },
  'logo.conversionFailure': { en: 'The image could not be converted locally.', yue: '圖片未能喺本機轉換。' },
  'logo.imported': { en: 'Logo appearance imported locally.', yue: '標誌外觀已喺本機匯入。' },
  'logo.importError': { en: 'The logo appearance file is invalid or uses an unknown schema. Nothing changed.', yue: '標誌外觀檔案無效或者用咗未知 schema，乜都冇改。' },
  'logo.scheduleAdded': { en: 'Logo schedule added locally.', yue: '標誌預約已喺本機加入。' },
